...
<footer class="footer_area section-gap-top">
    <div class="container">
        <div class="row footer_inner">
            <div class="col-lg-4">
                <div class="f_title footer-title">
                    <a class="navbar-brand" href="{{url('/')}}/home">
                        <img class="w-75" src="{{asset('public/uploads/settings/logo.png')}}" alt="">
                    </a>
                </div>
                <div class="f-desc">
                    <p>Our comprehensive platform not only consolidates various tasks like institute overview, fees, and accounts but also empowers your institution to enhance productivity and efficiency.</p>
                </div>    
            </div>  
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="footer-list">
                            <ul>
                                <li class="footer-contacts"><p><i class="ti-home"></i> Raisun Berinanto X<br>
2nd floor No. 21, Tansy nagar 17th street, velachery.<br> Near Bethel school gate no.4</p></li>
                                <li class="footer-contacts"><p><i class="ti-headphone-alt"></i> 7824931319</p></li>
                                <li class="footer-contacts"><p><i class="ti-envelope"></i> raisun@donboscoschools.in</p></li>
                            </ul>    
                        </div>        
                    </div> 
                </div>    
        ...
        <div class="row single-footer-widget">
            ...
            @if($social_permission)
                <div class="col-lg-4 col-md-3">
                    <div class="social_widget text-right">
