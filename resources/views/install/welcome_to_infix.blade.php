...
<head>
    ...
    <link rel="alternate" href="https://dreamstechnologies.com/" hreflang="en-us" />
    <title>Dreams Technologies school management software & School management system</title>
        ...
        <div class="card">
            ...
            <div class="single-report-admit">
                <div class="card-header">
                    <h2 class="text-center text-uppercase" style="color: whitesmoke">Welcome to Dreams Technologies </h2>
                
                </div>
            </div>

            <div class="card-body">
                  <p style="text-align: center">Thank you for choosing Dreams Technologies for your school administration. Please follow the steps to complete Dreams Technologies Edu installation!</p>
