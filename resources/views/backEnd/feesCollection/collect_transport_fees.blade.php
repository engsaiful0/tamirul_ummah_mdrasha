...
<section class="sms-breadcrumb mb-20 white-box">
    ...
    <div class="row">
            ...
            <h1>@lang('fees.collect_fees') Transport Fees</h1>
            <div class="bc-pages">
...
<section class="sms-breadcrumb mb-20 white-box">
    <div class="fees-btn">
        <a class="collect-fees eduction-fess" href="{{route('collect_fees')}}">Education Fees</a>
        <a class="collect-fees transport-fess active" href="{{route('collect_transport_fees')}}">Transport Fees</a>  
    </div>
</section>
...
<section class="admin-visitor-area">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'collect_transport_fees', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md infix_up_mt" id="select_section_div">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-8 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-5">@lang('fees.fees_collection_list')
                                        @if(! moduleStatusCheck('University'))
                                            ...
                                            @foreach($students as $student)
                                                <tr>
                                                    ...
                                                    @if(userPermission("fees_collect_student_wise"))
                                                        <td>
                                                            <a target="_blank" href="{{route('transport_fees_collect_student_wise', [$student->id])}}" class="primary-btn small tr-bg">
                                                                @lang('fees.collect_fees')
                                                            </a>
                                                        </td>
                                                    @endif
