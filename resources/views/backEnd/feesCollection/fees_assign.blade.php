        ...
        <div class="container-fluid">
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            @else
                                ...
                                <div class="col-lg-4 mt-30-md d-none">
                                    <select
            ...
            @if (isset($students))
                ...
                <div class="row mt-20">
                    <div class="col-lg-12">
                        <div class="row mb-20">
                            <div class="col-lg-6 no-gutters d-flex align-items-center">
                                <div class="main-title">
                                    <h3 class="mb-0">@lang('fees.assign_fees_group')</h3>
                                </div>
                            </div>
                            <div class="col-lg-6 text-right">
                                <a class="primary-btn fix-gr-bg mb-0 submit assign-btn" data-toggle="modal" data-target="#assignAllStudentsModal"
                                    href="">@lang('fees.assign_all_students')</a>
                                <a class="primary-btn fix-gr-bg mb-0 submit assign-btn" data-toggle="modal" data-target="#unassignAllStudentsModal"
