                    ...
                    <x-table>
                        <table class="table school-table-style" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    <td class="text-right" colspan="14">
                                        <a href="" id="transport_fees_groups_invoice_print_button" class="primary-btn small fix-gr-bg" target="">
                                            <i class="ti-printer pr-2"></i>
                                            @lang('fees.invoice_print')
                                        </a>
                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" id="fees_group.{{$index}}" class="common-checkbox fees-groups-print" name="fees_group[]" value="{{$index}}" {{ isset($monthlyPaid) ? ($monthlyPaid == 0 ? 'disabled' : '') : '' }}>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                @if(userPermission('fees-generate-modal'))
                                                    @if($balance_amount != 0) 
                                                        ...
                                                        title="@lang('fees.transport_fees'){{' : '. $month}}"
                                                        href="{{route('transport-fees-generate-modal', [$balance_amount,$student->student_id,$index,$month,$recordId,$route_id,$fee_amount])}}">@lang('fees.add_fees') </a>
                                    ...
                                    @php
                                    $payments = App\SmFeesAssign::transportFeesPayment($index, $student->student_id, $recordId);
                                    $i = 0;
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            @if($created_by != "")
                                                <a data-toggle="tooltip" data-placement="right" title="{{'Collected By: '.$created_by->full_name}}">{{$month}}</a>
                                        </td>
                                            @endif
                                        <td>{{$payment->payment_mode}}</td>
