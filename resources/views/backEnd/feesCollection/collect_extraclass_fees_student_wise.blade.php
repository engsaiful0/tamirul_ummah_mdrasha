...
<section class="sms-breadcrumb mb-20 white-box">
    ...
    <div class="row">
            ...
            <div class="bc-pages">
                ...
                <a href="{{route('extraclass_fees_collect_student_wise', [$student->id])}}">@lang('fees.student_wise')</a>
            </div>
        </div>
    </div>
</div>
...
<section class="student-details mb-20">
    <div class="container-fluid">
        <div class="row">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="d-flex justify-content-between">
                    <div class="main-title">
                        <h3 class="mb-0">@lang('fees.add_fees')</h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-8 text-right">
                <a href="" id="extra_curricular_fees_invoice_button" class="primary-btn small fix-gr-bg" target="">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <x-table>
                    <table id="" class="table school-table-style-parent-fees fees-discount-table" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <td class="text-right" colspan="14">
                                    <a class="primary-btn small fix-gr-bg modalLink" data-modal-size="modal-lg" title="@lang('fees.add_fees')" href="{{route('university.un-total-fees-modal', [$student->id])}}"0>
                                        <i class="ti ti-plus pr-2"></i> @lang('fees.add_fees') 
                                </a>
                ...
                @else 
                    <x-table>
                        <table class="table school-table-style fees-discount-table" cellspacing="0" width="100%">
                            <thead>
                            ...
                            <tbody>
                                ...
                                @foreach($extra_curricular_fees_assigneds as $fees_assigned)
                                @php
                                    ...
                                    $fine = App\SmExtraclassFees::feespaidSum($fees_assigned->student_id, 'fine', $fees_assigned->extra_curricular_record_id);
                                    if(empty($fine))
                                    { 
                                        $fine=0;
                                    }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{@$fees_assigned->feesExtraClass->class_name}}
                                    </td>
                                    <td>
                                        @if($fees_assigned->feesExtraClass !="")
                                            {{$fees_assigned->created_at != ""? dateConvert($fees_assigned->created_at):''}}
                                        @endif
                                    </td>
                                    <td>
                                        @php
                                            $rest_amount = $fees_assigned->fees_amount - $total_paid;
                                    ...
                                    <td>{{$fees_assigned->fees_amount}}</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                @if(userPermission('fees-generate-modal'))
                                                    @if($balance_amount != 0) 
                                                        ...
                                                        title="{{@$fees_assigned->feesExtraClass->class_name}}"  
                                                        href="{{route('extraclass-fees-generate-modal', [$balance_amount, $fees_assigned->student_id,$fees_assigned->id,$fees_assigned->extra_curricular_record_id])}}" >@lang('fees.add_fees') </a>
                                                    @else
                                    ...
                                    @php
                                        $payments = App\SmExtraclassFees::feesPayment($fees_assigned->student_id, $fees_assigned->record_id);
                                        $i = 0;
                                    @endphp
