...
<section class="sms-breadcrumb mb-20 white-box">
    ...
    <div class="row">
            ...
            <div class="bc-pages">
                ...
                <a href="#">@lang('fees.fees_report')</a>
                ...
                <table class="table school-table-style" cellspacing="0" width="100%">
                    ...
                    @php
                        ...
                        <tr>
                            ...
                            @php
                                $fees_created_by = App\SmFeesAssign::feesPaymentBy($payment->created_by);
                            @endphp
                            <tr>
                                <td></td>
                                <td title="Fees added By"><img src="{{asset('public/backEnd/img/table-arrow.png')}}" > {{ $fees_created_by->full_name }}</td>
                                <td></td>
                                <td class="text-right">
