...
<div class="container-fluid">
    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'transport-fees-payment-store',
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <input type="hidden" name="month_id" id="month_id" value="{{$month_id}}">
                <input type="hidden" name="month" id="month" value="{{$month}}">                
                <input type="hidden" name="real_amount" id="real_amount" value="{{$amount}}">
                <input type="hidden" id="student_id" name="student_id" value="{{$student_id}}">                
                <input type="hidden" name="record_id" value="{{@$record_id}}">
                <input type="hidden" name="route_id" value="{{@$route_id}}">
                <input type="hidden" name="assigned_fee_amount" value="{{@$assigned_fee_amount}}">
