...
@section('title') 
@lang('fees.search_extra_fees_due')
@endsection
@section('mainContent')
...
<section class="sms-breadcrumb mb-40 white-box">
    ...
    <div class="row">
            ...
            <h1>@lang('fees.search_extra_fees_due')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('common.dashboard')</a>
                <a href="#">@lang('fees.fees')</a>
                <a href="#">@lang('fees.search_extra_fees_due')</a>
            </div>
        </div>
</div>
</div>
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="fees-btn">
        <a class="collect-fees eduction-fess" href="{{route('search_fees_due')}}">Fees Due</a>
        <a class="collect-fees transport-fess active" href="{{route('search_extra_fees_due')}}">Extra Fees Due</a>
    </div>
</section>
...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">               
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'extra_fees_due_search', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
        ...
        {{ Form::open(['class' => 'form-horizontal', 'route' => 'send-dues-extrafees-email', 'method' => 'POST']) }}
        <div class="row mt-20">
            <div class="col-lg-6">
                <h3 class="mb-0 mb-2 mt-2 mr-2"> Extra Fees Due List</h3>
            </div>    
            <div class="col-lg-6 text-lg-right">
                <div class="fes_lag_btn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <x-table>
                                <table id="table_id" class="table data-table school-table" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>@lang('fees.id')</th>
                                            ...
                                            <th>@lang('fees.payable_amount') ({{generalSetting()->currency_symbol}}) </th>
       ...
       $('.data-table').DataTable({
                     ...
                     "ajax": $.fn.dataTable.pipeline( {
                       ...
                       columns: [
                           ...
                           // {data: 'date', name: 'date'},
                           {data: 'student_detail.full_name', name: 'full_name'},
