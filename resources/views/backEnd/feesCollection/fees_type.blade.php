        ...
        <div class="row"> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-20">@if(isset($fees_type))
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field text_numbers_only form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                                type="text" name="name" maxlength="60" autocomplete="off" value="{{isset($fees_type)? $fees_type->name: old('name')}}">
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <x-table>
                            <table id="table_id" class="table table-type mt-20" cellspacing="0" width="100%">
