...
<section class="sms-breadcrumb mb-20 white-box">
    <div class="fees-btn">
        <a class="collect-fees eduction-fess active" href="{{route('search_fees_payment')}}">Fees Payment</a>
        <a class="collect-fees transport-fess" href="{{route('search_extra_fees_payment')}}">Extra Fees Payment</a>
    </div>
</section>
                                        ...
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="">
                                                    ...
                                                    class="primary_input_field  primary_input_field fromDate form-control {{ $errors->has('date_from') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="">
                                                    ...
                                                    class="primary_input_field  primary_input_field toDate form-control {{ $errors->has('date_to') ? ' is-invalid' : '' }}"
                                                    type="text" autocomplete="off"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              {{ Form::open(['route' => 'reject-bank-fees-payment', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
...
<script>
   $(document).ready(function() {
        $('.fromDate').datepicker({
            ...
            if (from_date) {
                $('.toDate').datepicker('setStartDate', from_date);
            }
        });
        $('.toDate').datepicker({
            format: 'mm/dd/yyyy',
