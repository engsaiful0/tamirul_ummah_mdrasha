...
<section class="sms-breadcrumb mb-20 white-box">
    <div class="fees-btn">
        <a class="collect-fees eduction-fess active" href="{{route('search_fees_due')}}">Fees Due</a>
        <a class="collect-fees transport-fess" href="{{route('search_extra_fees_due')}}">Extra Fees Due</a>
    </div>
</section>
