                            ...
                            <thead>
                               <!--
                                <tr>
                                    <td class="text-right" colspan="14">
                                        <a href="" id="fees_groups_invoice_print_button" class="primary-btn small fix-gr-bg" target="">
                                            <i class="ti-printer pr-2"></i>test2
                                            @lang('fees.invoice_print')
                                        </a>
                                    </td>
                                </tr>-->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $discounted=false;
                                            if($discount_amount==$fees_assigned->feesGroupMaster->amount){
                                                $discounted=true;
                                            }
                                        @endphp
                                        
                                        @if($discounted == true)
                                            <button class="primary-btn small bg-info text-white border-0">@lang('fees.discounted')</button>
                                ...
                                <tr>
                                    ...
                                    <th>{{ currency_format($total_grand_paid) }}</th>
                                        @php
                                            ...
                                            $finalBalance = currency_format(abs($show_balance - $total_grand_paid));
                                        @endphp
                                    <th>{{ $finalBalance }}</th>
                                    <th></th>
                                </tr>
