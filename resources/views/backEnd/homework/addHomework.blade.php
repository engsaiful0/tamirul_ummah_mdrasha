    ...
    <section class="sms-breadcrumb mb-20 white-box">
        ...
        <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('submenu-list',['sub_menu' =>'homework']) }}">@lang('homework.home_work')</a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-title">
                        <h3 class="mb-20">@lang('homework.add_homework')</h3>
                    </div>
                </div>
            </div>
                            ...
                            @else
                                <div class="row mb-15">
                                    ...
                                    <div class="col-lg-4" id="selectSectionsDiv">
                                        <div class="primary_input">
                                            <label for="checkbox" class="primary_input_label">@lang('common.section') <span class="text-danger"> *</span></label>
                                        ...
                                        <div class="primary_datepicker_input">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="">
                                                        <input
                                                            class="primary_input_field primary_input_field homework_date form-control"
                                        ...
                                        <div class="primary_datepicker_input">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="">
                                                        <input
                                                            class="primary_input_field primary_input_field submission_date form-control"
