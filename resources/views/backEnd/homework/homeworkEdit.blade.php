                        ...
                        <div class="no-gutters input-right-icon">
                           <div class="col">
                              <div class="primary_input">
                                 ...
                                 <input class="primary_input_field  primary_input_field homework_date form-control form-control{{ $errors->has('homework_date') ? ' is-invalid' : '' }}" id="homework_date" type="text" name="homework_date" value="{{date('m/d/Y', strtotime($homeworkList->homework_date))}}" readonly="true">
                        ...
                        <div class="no-gutters input-right-icon">
                           <div class="col">
                              <div class="primary_input">
                                 ...
                                 <input class="primary_input_field  primary_input_field submission_date form-control form-control{{ $errors->has('submission_date') ? ' is-invalid' : '' }}" id="submission_date" type="text" name="submission_date" value="{{date('m/d/Y', strtotime($homeworkList->submission_date))}}" readonly="true">
...
<script>
    $(document).ready(function () {
        $('.homework_date').datepicker({
            ...
            var hw_date = $(this).datepicker('getDate');
            if (hw_date) {
                $('.submission_date').datepicker('setStartDate', hw_date);
            }
        });
        $('.submission_date').datepicker({
            format: 'mm/dd/yyyy',
            autoclose: true,
            startDate: $('.homework_date').val()
        });
    });
