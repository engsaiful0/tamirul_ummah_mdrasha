                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field text_numbers_only form-control{{ $errors->has('room_no') ? ' is-invalid' : '' }}" type="text" name="room_no" maxlength="20" autocomplete="off" value="{{isset($class_room)? $class_room->room_no: old('room_no')}}">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                         ...
                                         <div class="primary_input">
                                            ...
                                            <input oninput="numberCheckWithDot(this)" class="primary_input_field numeric-input form-control{{ $errors->has('capacity') ? ' is-invalid' : '' }}" type="text" name="capacity" maxlength="10" autocomplete="off" value="{{isset($class_room)? $class_room->capacity: old('capacity')}}">
