    ...
    <section class="sms-breadcrumb mb-20 white-box">
        ...
        <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('submenu-list',['sub_menu' =>'academics']) }}">@lang('academics.academics')</a>
                            ...
                            <li class="nav-item edit-button">
                                @if (userPermission('add-new-class-routine-store'))
                                    <button class="primary-btn small fix-gr-bg" onclick="addRowInRoutine();" id="addRowBtn">
                                        <span class="ti ti-plus pr-2"></span> @lang('common.add')</button>
                                @endif
        ...
        <tr id="row_${row_count}" class="0">
            <td class="border-top-0"> 
                <div class="primary_input">
                    <select class="primary_select  form-control selectSubject" name="routine[${row_count}][subject]" id="subject_${row_count}" >
            ...
            <td class="border-top-0">  
                <div class="row no-gutters input-right-icon">
                    <div class="col">
                        <div class="primary_input">
                            <input class="primary_input_field primary_input_field time  form-control{{ @$errors->has('start_time') ? ' is-invalid' : '' }} selectStartTime"  type="text" data-start_time_row_id="${row_count}" name="routine[${row_count}][start_time]" id="start_time_${row_count}">
            ...
            <td class="border-top-0">   
                <div class="row no-gutters input-right-icon">
                    <div class="col">
                        <div class="primary_input">
                            <input class="primary_input_field primary_input_field time  form-control{{ @$errors->has('end_time') ? ' is-invalid' : '' }} selectEndTime"   type="text" name="routine[${row_count}][end_time]"  data-end_time_row_id="${row_count}" id="end_time_${row_count}">
