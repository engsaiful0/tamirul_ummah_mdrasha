...
<section class="sms-breadcrumb mb-20 white-box">
    ...
    <div class="row">
            ...
            <div class="bc-pages">
                ...
                <a href="#">@lang('academics.assign_subject_create')</a>
            </div>
</div>
</div>
        </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-30" id="assign-subject-{{$i}}">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 mt-30-md">
                                             ...
                                             @if(userPermission('assign_subject_delete'))
                                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-12 mt-20 text-right">
                                <button type="submit" class="primary-btn small fix-gr-bg submit">
                                    <span class="ti-device-floppy pr-2"></span>
                                    @lang('academics.save')
                                </button>
                            </div>
                            @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <button class="primary-btn icon-only fix-gr-bg" type="button">
                                                    <span class="ti ti-trash" id="removeSubject" onclick="deleteSubject(4)"></span>
                                                </button>
                                            </div>
