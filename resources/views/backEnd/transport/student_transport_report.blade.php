                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-6 no-gutters">
                            <div class="main-title">
                                <h3 >@lang('transport.student_transport_report')</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
       ...
       table = $('.data-table').DataTable({
                    ...
                    "ajax": $.fn.dataTable.pipeline( {
                          ...
                          data: function(d) {
                              ...
                              d.class = $('#select_class').val();
                              d.section = $('#select_section').val();
                              d.route = $('select[name="route"]').val();
                              d.vehicle = $('select[name="vehicle"]').val();
                              @if(moduleStatusCheck('University'))
                              d.un_session_id = $('select[name="un_session_id"]').val();
                              d.un_faculty_id = $('select[name="un_faculty_id"]').val();
                              d.un_department_id = $('select[name="un_department_id"]').val();
                              d.un_academic_id = $('select[name="un_academic_id"]').val();
                              d.un_semester_id = $('select[name="un_semester_id"]').val();
                              d.un_semester_label_id = $('select[name="un_semester_label_id"]').val();
                              @endif
                          },
                ...
                // Reload DataTable when form is submitted
