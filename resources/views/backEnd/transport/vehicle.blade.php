                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-20">@if(isset($assign_vehicle))
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field vehicle_no_chk form-control{{ $errors->has('vehicle_number') ? ' is-invalid' : '' }}"
                                                type="text" name="vehicle_number" maxlength="10" autocomplete="off" value="{{isset($assign_vehicle)? @$assign_vehicle->vehicle_no:old('vehicle_number')}}">
...
@section('script')
<script>
    $('.vehicle_no_chk').keypress(function (e) {
