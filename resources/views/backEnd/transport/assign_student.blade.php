        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('fees_assign', [$route_id]) }}">@lang('fees.fees_assign')</a>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'assign-student-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_studentA']) }}
                        <div class="row">
            ...
            @if (isset($students))
                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'url' => 'btn-assign-student-transport', 'enctype' => 'multipart/form-data']) }}
                <input type="hidden" name="route_id" id="route_id" value="{{ @$route_id }}">
                <div class="row mt-40">
                    <div class="col-lg-12">
                        <div class="row mb-30">
                            <div class="col-lg-6 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-0">@lang('transport.assign_student_routes')</h3>
                                </div>
                            </div>
                        </div>
                        <!-- </div> -->
                        <div class="row">
                            <div class="col-lg-4">
                                <div id="table_id_table_wrapper" class="dataTables_wrapper">
                                        <p>@lang('transport.route_name') : {{ @$routes[0]->title }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-12 search_hide_md">
                    ...
                    <a class="primary-btn fix-gr-bg mb-0 submit" data-toggle="modal" data-target="#unassignAllStudentsModal"
                        href="">@lang('fees.unassign_all_students')</a><br><br><br> -->
                    <x-table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'method' => 'POST', 'url' => 'btn-assign-student-transport', 'enctype' => 'multipart/form-data']) }}
                        <input type="hidden" name="route_assign_class"
                            value="{{ isset($requestData) ? $requestData['class'] : '' }}">
                        <input type="hidden" name="route_assign_section"
                            value="{{ isset($requestData) ? $requestData['section'] : '' }}">
                        <input type="hidden" name="route_id" id="route_id" value="{{ @$route_id }}">
                        <input type="hidden" name="route_assign_all" value="1">
        ...
        $(document).ready(function() {
            $('#table_id').DataTable({
                ...
                "ajax": $.fn.dataTable.pipeline({
                    url: "{{ url('route-assign-datatable') }}",
                    data: {
