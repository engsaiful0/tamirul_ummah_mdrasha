            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="main-title">
                        <h3 class="mb-20">@lang('communicate.send_email_sms') </h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="row student-details mt_0_sm">
                                <!-- Start Sms Details -->
                                <div class="col-lg-12">
                                    <ul class="nav nav-tabs mt_0_sm mb-20 ml-0" role="tablist">
                                        <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <button class="primary-btn fix-gr-bg">
                                <span class="ti ti-check"></span> @lang('communicate.send')
                            </button>
                        </div>
                    </div>
                </div>
