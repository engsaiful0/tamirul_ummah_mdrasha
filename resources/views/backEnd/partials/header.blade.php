...
<head>
    ...
    @endif
    <title>{{@schoolConfig()->school_name ? @schoolConfig()->school_name : 'Dreams Technologies'}} 
        @yield('title')
    </title>
...
<link rel="stylesheet" href="{{ asset('public/frontend/theme/fonts/tabler-icons.min.css')}}" />
