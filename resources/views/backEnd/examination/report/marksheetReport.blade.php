                        ...
                        <div class="single-report-admit">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3">
                                        <h3 class="text-white">@lang('exam.exam_code') : {{$exam_code!='' ?$exam_code:' - '}}</h3>
                                        <h3 class="text-white">@lang('exam.exam_name') : {{$exam_name!='' ?$exam_name:' - '}}</h3>
                                    </div>

                                    <div class=" col-lg-3 text-left text-lg-right mt-30-md">
