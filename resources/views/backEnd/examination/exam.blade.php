...
<section class="sms-breadcrumb mb-20 white-box">
    ...
    <div class="row">
            ...
            <div class="bc-pages">
                ...
                <a href="{{ route('submenu-list',['sub_menu' =>'examination']) }}">@lang('exam.examination')</a>
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('exam.exam_name') <span
                                                    class="text-danger"> *</span></label>
                                            <input class="primary_input_field form-control{{ $errors->has('exam_name') ? ' is-invalid' : '' }}"
                                                type="text" name="exam_name" id="exam_name_main" autocomplete="off"
                                                 >
                                            @if ($errors->has('exam_name'))
                                            <span class="text-danger">
                                                {{ $errors->first('exam_name') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('exam.exam_code') <span
                                                    class="text-danger"> *</span></label>
                                            <input class="primary_input_field form-control{{ $errors->has('exam_code') ? ' is-invalid' : '' }}"
                                                type="text" name="exam_code" id="exam_code_main" autocomplete="off"
                                                 >
                                            @if ($errors->has('exam_code'))
                                            <span class="text-danger">
                                                {{ $errors->first('exam_code') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="white-box mt-10">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <button style="position: relative; top: -5px;margin-left: 5px;" type="button"
                                        class="primary-btn icon-only fix-gr-bg" onclick="addRowMark();" id="addRowBtn">
                                        <span class="ti ti-plus pr-2"></span></button>
</div>    
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="table-responsive">
                                <table class="table" id="productTable" style="width:300px">
                                    <thead>
                                        <tr>
                            ...
                            <table id="table_id" class="table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $exam->exam_name!='' ?$exam->exam_name:'-' }}</td>
                                        <td>{{ $exam->exam_code!='' ?$exam->exam_code:'-' }}</td>
                                        @if (moduleStatusCheck('University'))
