        ...
        <div class="row mt-40">
            ...
            <div class="col-lg-3  col-md-3 ">
              <a href="{{route('exam-routine-print', [$class_id, $section_id,$exam_type_id])}}" class="primary-btn small fix-gr-bg pull-left" target="_blank"><i class="ti-printer"> </i> @lang('common.print')</a>
                    <button  class="primary-btn small fix-gr-bg pull-right" onclick="addRowInExamRoutine();" id="addRowBtn"> <span class="ti ti-plus pr-2"></span> @lang('common.add')</button>
            </div>
        </div>
                ...
                addRowInExamRoutine = () => {
                    ...
                    let row_count = parseInt($('#row_count').val());
                        var tr=`<tr class="0" id="row_${row_count}">
                                                ...
                                                <td class="border-top-0 td-cust-width-1">
                                                    <div class="primary_input mb-15">
                                                ...
                                                <td class="border-top-0">  
                                                    <div class="row no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="primary_input">
                                                                <input class="pl-2 pr-0 primary_input_field primary_input_field time start_time form-control{{ @$errors->has('start_time') ? ' is-invalid' : '' }}" type="text" id="start_time_${row_count}" name="routine[${row_count}][start_time]" required>
                                                ...
                                                <td class="border-top-0">   
                                                    <div class="row no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="primary_input">
                                                                <input class="pl-2 pr-0 primary_input_field primary_input_field time end_time  form-control{{ @$errors->has('end_time') ? ' is-invalid' : '' }}" type="text" id="end_time_${row_count}" data-row_id="${row_count}" name="routine[${row_count}][end_time]" required>
