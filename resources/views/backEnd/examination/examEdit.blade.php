                                ...
                                <div class="row mt-25">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input">
                                            ...
                                            type="text" name="exam_name" id="exam_name_main" autocomplete="off" value="{{isset($exam)? $exam->exam_name: ''}}" required="">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('exam.exam_code') <span class="text-danger"> *</span></label>
                                            <input class="primary_input_field form-control{{ $errors->has('exam_code') ? ' is-invalid' : '' }}"
                                            type="text" name="exam_code" id="exam_code_main" autocomplete="off" value="{{isset($exam)? $exam->exam_code: ''}}" required="">
