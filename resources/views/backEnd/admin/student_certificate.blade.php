...
@section('mainContent')
<section class="sms-breadcrumb mb-20 white-box up_breadcrumb">
...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="offset-lg-10 col-lg-3 text-right col-md-12 mb-20">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-20">@if(isset($certificate))
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            <label>@lang('admin.header_center_text')<span></span></label>
                                            <input class="primary_input_field{{ $errors->has('header_center_text') ? ' is-invalid' : '' }}"
                                                type="text" name="header_center_text" autocomplete="off" value="{{isset($certificate)? $certificate->header_center_text: old('header_center_text')}}">
                                           
                                            @if ($errors->has('header_center_text'))
                                            <span class="text-danger" >
                                                {{ $errors->first('header_center_text') }}
                                            </span>
                                            @endif
                                        </div>
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="primary_input_field form-control" cols="0" rows="4" name="body" maxlength="500">{{isset($certificate)? $certificate->body: old('body')}}</textarea>
                                            @if($errors->has('body'))
                                        ...
                                        <span class="text-primary">
                                            ...
                                            @else 
                                            [class] [section] [academic_year] [school_name]
                                            @endif 
                                        </span>
                                    </div>
                                </div>
                                <div class="row mt-15" id="body_two_part">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <textarea class="primary_input_field summer_note form-control" cols="0" rows="4" name="body_two" maxlength="500">{{isset($certificate)? $certificate->body_two: old('body_two')}}</textarea>
            ...
            <div class="col-lg-7">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <x-table>
                            <table id="table_id" class="display school-table white-box" cellspacing="0" width="100%">
