    ...
    <section class="sms-breadcrumb mb-20 white-box up_breadcrumb">
        ...
        <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('submenu-list',['sub_menu' =>'admin_section']) }}">@lang('admin.admin_section')</a>
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                ...
                                                name="complaint_type">
                                                @if(isset($complaint_types) && $complaint_types=='')
                                    ...
                                    <div class="row mt-15">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                ...
                                                @if(isset($complaint_sources) && $complaint_sources=='')
