...
@endpush
@section('mainContent')
    <section class="sms-breadcrumb mb-20 ml-3">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="white-box">
                                ...
                                <div class="add-visitor {{isset($update)? '':'isDisabled'}}">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                             ...
                                             <input type="hidden" name="description" id="description" value="{{ $about_us->description ?? '' }}"/>
                                    ...
                                    <div class="row  mt-15">
                                       @php
                                            $placeholder = trans('front_settings.image') . ' *';
                                            if (isset($update) && $about_us && $about_us->image != "") {
                                                $placeholder = getFilePath3($about_us->image);
                                            }
                                            
                                            $placeholder1 = trans('front_settings.image') . ' *';
                                            if (isset($update) && $about_us && $about_us->main_image != "") {
                                                $placeholder1 = getFilePath3($about_us->main_image);
                                            }

                                            $placeholder2 = trans('front_settings.image') . ' *';
                                            if (isset($update) && $about_us && $about_us->main_image_2 != "") {
                                                $placeholder2 = getFilePath3($about_us->main_image_2);
                                            }
                                    ...
                                    <span class="mt-10">@lang('front_settings.image')(500px*500px)</span>
                                    <div class="row  mt-15">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                ...
                                                <div class="primary_file_uploader">
                                                    <input class="primary_input_field form-control{{ $errors->has('main_image') ? ' is-invalid' : '' }}" id="placeholderPhoto1" type="text"
                                                       placeholder="{{ $placeholder1 }}"
                                                       readonly>
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg" for="browseFile1">{{ __('common.browse') }}</label>
                                                        <input type="file" class="d-none" name="main_image" id="browseFile1">
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <span class="mt-10">@lang('front_settings.image')(500px*500px)</span>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label"> {{ __('front_settings.main_image_2') }} <span class="text-danger"> *</span></label>
                                                <div class="primary_file_uploader">
                                                    <input class="primary_input_field form-control{{ $errors->has('main_image_2') ? ' is-invalid' : '' }}" id="placeholderPhoto2" type="text"
                                                       placeholder="{{ $placeholder2 }}"
                                                       readonly>
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg" for="browseFile2">{{ __('common.browse') }}</label>
                                                        <input type="file" class="d-none" name="main_image_2" id="browseFile2">
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table school-table-style" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="20%">{{$about_us != ""? $about_us->main_description:""}}</td>
