    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <x-table>
                    <table id="table_id" class="table data-table Crm_table_active3 no-footer dtr-inline"
                        ...
                        <tbody>
                            ...
                            @php
                            $exam_code = App\SmStudent::examCode($exam_routine->exam_term_id,$exam_routine->subject_id);
                            @endphp
                            <tr>
                                <td>{{ dateConvert($exam_routine->date) }}
                                    <br>{{ Carbon::createFromFormat('Y-m-d', $exam_routine->date)->format('l'); }}</td>
                                <td>{{$exam_code->exam_code!=''?$exam_code->exam_code:' - '}}</td>
                                <td>
