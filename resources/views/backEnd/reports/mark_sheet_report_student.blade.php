    ...
    <section class="sms-breadcrumb mb-20 white-box">
        ...
        <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="#">@lang('reports.exam_report')</a>
                                                        ...
                                                        <table class="table @if(resultPrintStatus('vertical_boarder')) mt-5 @endif">
                                                            ...
                                                            @if(@$generalsettingsResultType != 'mark')
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @php
                                                                            // Count how many subjects failed
                                                                            $failed_count = 0;
                                                                            foreach($temp_grade as $grade) {
                                                                                if($grade == $failgpaname->grade_name) {
                                                                                    $failed_count++;
                                                                                }
                                                                            }
                                                                            
                                                                            // If only one subject failed, show grade based on calculated GPA (skip the fail grade)
                                                                            // If more than one subject failed, show fail grade
                                                                            if($failed_count == 1) {
                                                                                // Only one subject failed - show grade based on calculated GPA
                                                                                if($final_result >= $maxGrade){
                                                                                    $grade_details = App\SmResultStore::remarks($maxGrade);
                                                                                } else {
                                                                                    $grade_details = App\SmResultStore::remarks($final_result);
                                                                                }
                                                                                echo $grade_details->grade_name;
                                                                            } else if($failed_count > 1) {
                                                                                // More than one subject failed - show fail grade
                                                                                echo $failgpaname->grade_name;
                                                                            } else {
                                                                                // No subjects failed - calculate normal grade
                                                                                if($final_result >= $maxGrade){
                                                                                    $grade_details = App\SmResultStore::remarks($maxGrade);
                                                                                } else {
                                                                                    $grade_details = App\SmResultStore::remarks($final_result);
                                                                    ...
                                                                    <td class="nowrap">
                                                                        @php
                                                                            ...
                                                                            // If only one subject failed, show evaluation based on calculated GPA (skip the fail description)
                                                                            // If more than one subject failed, show fail description
                                                                            if($failed_count == 1) {
                                                                                // Only one subject failed - show evaluation based on calculated GPA
                                                                                if($final_result >= $maxGrade){
                                                                                    $grade_details = App\SmResultStore::remarks($maxGrade);
                                                                                } else {
                                                                                    $grade_details = App\SmResultStore::remarks($final_result);
                                                                                }
                                                                                echo $grade_details->description;
                                                                            } else if($failed_count > 1) {
                                                                                // More than one subject failed - show fail description
                                                                                echo $failgpaname->description;
                                                                            } else {
                                                                                // No subjects failed - calculate normal evaluation
                                                                                if($final_result >= $maxGrade){
                                                                                    $grade_details = App\SmResultStore::remarks($maxGrade);
                                                                                } else {
                                                                                    $grade_details = App\SmResultStore::remarks($final_result);
