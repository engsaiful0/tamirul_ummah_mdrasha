                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-20">@if(isset($student_type))
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field text_numbers_only form-control{{ $errors->has('category') ? ' is-invalid' : '' }}"
                                                type="text" name="category" maxlength="60" autocomplete="off" value="{{isset($student_type)? $student_type->category_name:''}}">
