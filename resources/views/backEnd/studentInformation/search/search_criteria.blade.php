...
<div class="{{ $div . ' ' . $mt }}" id="common_select_student_div">
    ...
    <span class="text-danger"  id="student_error"></span>
...
<div class="{{ $div . ' ' . $mt }}" id="common_select_student_div">
    <label class="primary_input_label" for="">{{ __('fees.fee_category') }}
        <span class="text-danger">{{ in_array('student', $required) ? '*' : '' }}</span>
    </label>
    <select class="primary_select form-control{{ $errors->has('student') ? ' is-invalid' : '' }}"
        id="select_fees_category" name="fees_category">
        <option data-display="@lang('fees.select_fees_category') *" value="">
            @lang('fees.select_fees_category') <span>*</span>
        </option>
        @isset($fees_category)
        @foreach ($fees_category as $fees)
    ...
    <span class="text-danger"  id="fees_category_error"></span>
