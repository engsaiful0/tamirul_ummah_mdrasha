    ...
    <div class="white-box">
         ...
         @if (is_show('caste'))
            <div class="single-info">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="">
                            {{ isset($student_detail->caste) ? @$student_detail->caste : '' }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="single-info">
            <div class="row">
                <div class="col-lg-5 col-md-5">
                    <div class="">
                        @lang('student.mother_tongue')
                    </div>
                </div>

                <div class="col-lg-7 col-md-6">
                    <div class="">
                        {{ isset($student_detail->mother_tongue) ? @$student_detail->mother_tongue : '' }}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="single-info">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="">
                        {{ isset($std_extra_curricular_classes) ? @$std_extra_curricular_classes : '' }}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="w-100">
                ...
                <div class="single-info">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                @lang('student.fathers_email')
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-7">
                            <div class="">
                                {{ @$student_detail->parents != '' ? @$student_detail->parents->fathers_email : '' }}
                            </div>
                        </div>
                    </div>
                </div>                
            ...
            <div class="w-100">
                ...
                <div class="single-info">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                @lang('student.mothers_email')
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-7">
                            <div class="">
                                {{ @$student_detail->parents != '' ? @$student_detail->parents->mothers_email : '' }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="single-info">
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="">
                                @lang('student.parent_address')
                            </div>
                        </div>

                        <div class="col-lg-8 col-md-7">
                            <div class="">
                                {{ $student_detail != '' ? @$student_detail->parent_address : '' }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <h4 class="stu-sub-head mt-40">@lang('student.document_info')</h4>
        ...
        @if (is_show('national_id_number'))
            <div class="single-info">
                <div class="row">
                    <div class="col-lg-5 col-md-5">
                        <div class="">
                            @lang('student.aadhar_card_number')
                        </div>
                    </div>
        ...
        @if (is_show('local_id_number'))
            <div class="single-info">
                <div class="row">
                    <div class="col-lg-5 col-md-5">
                        <div class="">
                            @lang('student.birth_certificate_number')
                        </div>
                    </div>
        ...
        <!-- Student Other Info Part-->
        @include('backEnd.studentInformation.student_other_info_view')
