...
<div class="row mb-4 align-items-end" id="div_id_{{ $record->student_id.$record->id }}">
    ...
    <div class="col-1 text-left">
        <button class="primary-btn small fix-gr-bg icon-only removrButton" type="button" data-student_id="{{ $record->student_id }}" data-record_id={{ $record->id }}><i class="ti ti-trash"></i></button>
    </div>
</div>
@endforeach
