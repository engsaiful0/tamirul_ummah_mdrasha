...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid">
            <div class="row mb-20">
                <div class="col-lg-6 col-sm-6 d-flex align-content-center">
            ...
            @if (userPermission('student_store'))
                {{ Form::open(['class' => 'form-horizontal studentadmission', 'route' => 'student_store', 'method' => 'POST', 'files' => true, 'enctype' => 'multipart/form-data', 'id' => 'student_form']) }}
            @endif
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="">
                            ...
                            <div class="row mb-15 mt-15">
                                <div class="col-lg-3">
                                    <div class="primary_input ">
                                        ...
                                        <select class="primary_select session" name="session" id="academic_year">
                                            <option
                                ...
                                <div class="col-lg-3">
                                    <div class="primary_input " id="class-div">
                                        <label class="primary_input_label" for="">@lang('common.class') <span
                                                class="text-danger"> *</span> </label>
                                        <select
                                            class="primary_select class form-control{{ $errors->has('class') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input " id="sectionStudentDiv">
                                            <label class="primary_input_label" for="">@lang('common.section') <span
                                                    class="text-danger"> *</span> </label>
                                            <select
                                                class="primary_select section form-control{{ $errors->has('section') ? ' is-invalid' : '' }}"
                                                name="section"
                                ...
                                @if (is_show('admission_number'))
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field admission_number form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}" type="text" name="admission_number" placeholder="(ex:{{ $max_admission_id }})">
                                            <span class="error text-danger d-none help-block"></span>
                                 ...
                                 @if (is_show('roll_number'))
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <input oninput="numberCheck(this)" class="primary_input_field roll_number form-control{{ $errors->has('roll_number') ? ' is-invalid' : '' }}" type="text" id="roll_number" name="roll_number" value="{{ old('roll_number') }}">
                                            <span class="error text-danger d-none help-block"></span>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            <label class="primary_input_label" for="">@lang('student.first_name')
                                                ...
                                                @endif </label>
                                            <input
                                                class="primary_input_field first_name form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}"
                                ...
                                @if (is_show('last_name'))
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <input
                                                class="primary_input_field last_name form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            <label class="primary_input_label" for="">@lang('common.gender')
                                                ...
                                                @endif </label>
                                            <select
                                                class="primary_select gender form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}"
                                                name="gender">
                                                <option
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input
                                                                class="primary_input_field primary_input_field student_dob form-control date_of_birth"
                                                                id="date_of_birth" type="text" name="date_of_birth"
                                                                value="{{ old('admission_date') != '' ? old('admission_date') : '' }}"
                                                                autocomplete="off">
                                                                <span class="error text-danger d-none help-block"></span>
                                                        </div>
                                                    </div>
                                                    <button class="btn-date" style="top: 20px !important;" data-id="#date_of_birth" type="button">
                                ...
                                @if (is_show('blood_group'))
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <select
                                                class="primary_select blood_group form-control{{ $errors->has('blood_group') ? ' is-invalid' : '' }}"
                                                name="blood_group">
                                                <option
                                ...
                                @if (is_show('religion'))
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <select
                                                class="primary_select religion form-control{{ $errors->has('religion') ? ' is-invalid' : '' }}"
                                                name="religion">
                                                <option
                                ...
                                @if (is_show('caste'))
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <input class="primary_input_field caste form-control{{ $errors->has('caste') ? ' is-invalid' : '' }}" type="text" name="caste"
                                                value="{{ old('caste') }}">
                                            <span class="error text-danger d-none help-block"></span>
                                            @if ($errors->has('caste'))
                                                <span class="text-danger">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            ...
                                            <input oninput="phoneCheck(this)"
                                                ...
                                                type="tel" name="phone_number" maxlength="15" id="phone_number"
                                        ...
                                        <div class="primary_input ">
                                            <div class="primary_input ">
                                                <label class="primary_input_label" for="">@lang('student.category')
                                                    ...
                                                    @endif </label>
                                                <select
                                                    class="primary_select student_category_id form-control{{ $errors->has('student_category_id') ? ' is-invalid' : '' }}"
                                ...
                                <div class="row mb-15">
                                    @if (is_show('source_id'))
                                        <div class="col-lg-4 ">
                                            <div class="primary_input">
                                                <select
                                                    class="primary_select source_id form-control{{ $errors->has('route') ? ' is-invalid' : '' }}"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    @foreach ($extraclasses as $class)
                                            ...
                                            <input type="checkbox" id="extraclass_{{ @$class->id }}"
                                                    value="{{ @$class->id }}" name="extraclass[]">
                            ...
                            @if (generalSetting()->with_guardian)
                                ...
                                <div class="modal fade admin-query" id="editStudent">
                                                                ...
                                                                <div class="row mt-15">
                                                                    <div class="col-lg-12" id="sibling_name_div">
                                                                        <label for="primary_input_label">@lang('common.relationship')
                                                                            <span class="text-danger"> *</span></label>
                                                                            <input class="primary_input_field form-control" type="text" name="relationship" id="relationship" value="">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-12 text-center mt-40">
                                                                <div class="mt-40 d-flex justify-content-between">
                                                                    <button type="button" class="primary-btn tr-bg"
                                                                        ...
                                                                        <!--old button id save_button_parent-->
                                                                    <button class="primary-btn fix-gr-bg"
                                                                        id="save_sibling_button" data-dismiss="modal"
                                    ...
                                    <div class="row mt-40 mb-4" id="addSibling">
                                    ...
                                    <div class="row mb-15 mt-30">
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.father_name')
                                                        ...
                                                        @endif </label>
                                                    <input
                                                        class="primary_input_field fathers_name form-control{{ $errors->has('fathers_name') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input class="primary_input_field fathers_occupation form-control{{ $errors->has('fathers_occupation') ? ' is-invalid' : '' }}" type="text"
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input oninput="phoneCheck(this)"
                                                        class="primary_input_field fathers_phone form-control{{ $errors->has('fathers_phone') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input oninput="emailCheck(this)"
                                                        class="primary_input_field fathers_email form-control{{ $errors->has('fathers_email') ? ' is-invalid' : '' }}"
                                                ...
                                                <div class="primary_input">
                                                    ...
                                                    <div class="primary_file_uploader">
                                                        ...
                                                        <button class="" type="button">
                                                            ...
                                                            <input type="file" class="fathers_photo d-none" name="fathers_photo"
                                                                id="fathers_photo">
                                                        </button>
                                                    </div>
                                                    <span class="error text-danger d-none help-block"></span>
                                    ...
                                    <div class="row mb-15 mt-30">
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.mother_name')
                                                        ...
                                                        @endif </label>
                                                    <input
                                                        class="primary_input_field mothers_name form-control{{ $errors->has('mothers_name') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input class="primary_input_field mothers_occupation form-control{{ $errors->has('mothers_occupation') ? ' is-invalid' : '' }}" type="text"
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input oninput="phoneCheck(this)"
                                                        class="primary_input_field mothers_phone form-control{{ $errors->has('mothers_phone') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input oninput="emailCheck(this)"
                                                        class="primary_input_field mothers_email form-control{{ $errors->has('mothers_email') ? ' is-invalid' : '' }}"
                                                ...
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <div class="primary_file_uploader">
                                                        ...
                                                        <button class="" type="button">
                                                            ...
                                                            <input type="file" class="mothers_photo d-none" name="mothers_photo"
                                                                id="mothers_photo">
                                                        </button>
                                                    </div>
                                                    <span class="error text-danger d-none help-block"></span>
                                                ...
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.address')
                                                        @if (is_required('parent_address') == true)
                                                            <span class="text-danger"> *</span>
                                                        @endif </label>
                                                    <textarea class="primary_input_field parent_address form-control{{ $errors->has('parent_address') ? ' is-invalid' : '' }}" cols="0" rows="3" name="parent_address"
                                                        id="parent_address">{{ old('parent_address') }}</textarea>
                                                    <span class="error text-danger d-none help-block"></span>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.guardian_name')
                                                        ...
                                                        @endif </label>
                                                    <input
                                                        class="primary_input_field guardians_name form-control{{ $errors->has('guardians_name') ? ' is-invalid' : '' }}"
                                                ...
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.relation_with_guardian')
                                                        @if (is_required('relation') == true)
                                                            <span class="text-danger"> *</span>
                                                        @endif </label>
                                                    <input class="primary_input_field relation read-only-input" type="text"
                                        ...
                                        @if (is_show('guardians_email'))
                                            <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input oninput="emailCheck(this)"
                                                        class="primary_input_field guardians_email form-control{{ $errors->has('guardians_email') ? ' is-invalid' : '' }}"
                                                ...
                                                <div class="primary_input">
                                                    ...
                                                    <div class="primary_file_uploader">
                                                        ...
                                                        <button class="" type="button">
                                                            ...
                                                            <input type="file" class="guardians_photo d-none" name="guardians_photo"
                                                                id="guardians_photo">
                                                        </button>
                                                    </div>
                                                    <span class="error text-danger d-none help-block"></span>
                                        ...
                                        @if (is_show('guardians_phone'))
                                            <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input
                                                        class="primary_input_field guardians_phone form-control{{ $errors->has('guardians_phone') ? ' is-invalid' : '' }}"
                                        ...
                                        @if (is_show('guardians_occupation'))
                                            <div class="col-lg-3">
                                                <div class="primary_input ">
                                                    ...
                                                    <input class="primary_input_field guardians_occupation form-control{{ $errors->has('guardians_occupation') ? ' is-invalid' : '' }}" type="text"
                                                ...
                                                <div class="primary_input ">
                                                    <label class="primary_input_label" for="">@lang('student.guardian_address')
                                                        @if (is_required('guardians_address') == true)
                                                            <span class="text-danger"> *</span>
                                                        @endif </label>
                                                    <textarea class="primary_input_field guardians_address form-control{{ $errors->has('guardians_address') ? ' is-invalid' : '' }}" cols="0" rows="3" name="guardians_address"
                                    ...
                                    @if (is_show('lead_city'))
                                        <div class="col-lg-4 ">
                                            <div class="primary_input" style="margin-top:53px !important">
                                                <select
                                                    class="primary_select lead_city form-control{{ $errors->has('route') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="primary_input  mt-20">
                                            <label class="primary_input_label" for="">@lang('student.current_address')
                                                @if (is_required('current_address') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif </label>
                                            <textarea class="primary_input_field current_address form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="primary_input  mt-20">
                                            <label class="primary_input_label" for="">@lang('student.permanent_address')
                                                @if (is_required('permanent_address') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif </label>
                                            <textarea class="primary_input_field permanent_address form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}"
                                    ...
                                    @if (is_show('route'))
                                        <div class="col-lg-3">
                                            <div class="primary_input ">
                                                ...
                                                <select
                                                    class="primary_select route form-control{{ $errors->has('route') ? ' is-invalid' : '' }}"
                                                    name="route" id="route">
                                                    <option
                                    ...
                                    @if (is_show('vehicle'))
                                        <div class="col-lg-3">
                                            <div class="primary_input " id="select_vehicle_div">
                                                ...
                                                <select class="primary_select vehicle form-control{{ $errors->has('vehicle') ? ' is-invalid' : '' }}" name="vehicle" id="selectVehicle">
                                                    <option
                                    ...
                                    @if (is_show('dormitory_name'))
                                        <div class="col-lg-3">
                                            <div class="primary_input ">
                                                ...
                                                <select
                                                    class="primary_select dormitory_name form-control{{ $errors->has('dormitory_name') ? ' is-invalid' : '' }}"
                                    ...
                                    @if (is_show('room_number'))
                                        <div class="col-lg-3">
                                            <div class="primary_input " id="roomNumberDiv">
                                                ...
                                                <select
                                                    class="primary_select room_number form-control{{ $errors->has('room_number') ? ' is-invalid' : '' }}"
                           ...
                           <!--Dormitary and Other Info-->
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input ">
                                            <label class="primary_input_label" for="">@lang('student.nin_number')
                                                ...
                                                @endif </label>
                                            <input
                                                class="primary_input_field national_id_number form-control{{ $errors->has('national_id_number') ? ' is-invalid' : '' }}"
                                ...
                                @if (is_show('local_id_number'))
                                    <div class="col-lg-3">
                                        <div class="primary_input_label ">
                                            <label> @lang('student.birth_certificate_number')@if (is_required('local_id_number') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif </label>
                                            <input class="primary_input_field local_id_number form-control{{ $errors->has('local_id_number') ? ' is-invalid' : '' }}" type="text" name="local_id_number"
                                        ...
                                        <div class="primary_input ">
                                            <label class="primary_input_label" for="">@lang('accounts.bank_account_number')
                                                @if (is_required('bank_account_number') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif </label>
                                            <input class="primary_input_field bank_account_number form-control{{ $errors->has('bank_account_number') ? ' is-invalid' : '' }}" type="text" name="bank_account_number"
                                        ...
                                        <div class="primary_input ">
                                            <label class="primary_input_label" for="">@lang('student.bank_name')
                                                @if (is_required('bank_name') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif </label>
                                            <input class="primary_input_field bank_name form-control{{ $errors->has('bank_name') ? ' is-invalid' : '' }}" type="text" name="bank_name"
                                                value="{{ old('bank_name') }}">
                                            <span class="error text-danger d-none help-block"></span>
                            ...
                            <div class="row mb-30">
                                    ...
                                    <div class="primary_input">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary_input_field" type="text" id="placeholderFileOneName"
                                                placeholder="@lang('student.nin')  @if (is_required('document_file_1') == true) * @endif"
                                                readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                    ...
                                    <div class="primary_input">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary_input_field" type="text" id="placeholderFileTwoName"
                                                placeholder="@lang('student.birth_certificate')  @if (is_required('document_file_2') == true) * @endif"
                                                readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                    ...
                                    <div class="primary_input">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary_input_field" type="text"
                                                ...
                                                placeholder="@lang('student.transfer_certificate')  @if (is_required('document_file_3') == true) * @endif"
                                                readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                ...
                                @if (is_show('ifsc_code'))
                                    <div class="col-lg-3">
                                        ...
                                        <input class="primary_input_field ifsc_code form-control{{ $errors->has('ifsc_code') ? ' is-invalid' : '' }}" type="text"
                                ...
                                @if (is_show('previous_school_details'))
                                    <div class="col-lg-6">
                                        <div class="primary_input ">
                                            ...
                                            <textarea class="primary_input_field previous_school_details form-control{{ $errors->has('previous_school_details') ? ' is-invalid' : '' }}" cols="0" rows="3" name="previous_school_details">{{ old('previous_school_details') }}</textarea>
                                            <span class="error text-danger d-none help-block"></span>
                                ...
                                @if (is_show('additional_notes'))
                                    <div class="col-lg-6">
                                        <div class="primary_input ">
                                            ...
                                            <textarea class="primary_input_field additional_notes form-control{{ $errors->has('additional_notes') ? ' is-invalid' : '' }}" cols="0" rows="3" name="additional_notes">{{ old('additional_notes') }}</textarea>
                                            <span class="error text-danger d-none help-block"></span>
                            ...
                            <!--Other Info-->
                            @include('backEnd.studentInformation.student_other_info')
                            <!--Other Info End-->
...
@section('script')
    ...
    <script>
        var form_submit_url = "{{ route('student_store') }}";
        var form_submit_text = "{{ __('student.save_student') }}";
        $(document).ready(function() {
            ...
            $('#student_form').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    beforeSend: function () {
                        $(".help-block").empty();
                        $("#_submit_btn_admission").attr("disabled", true);
                        $("#_submit_btn_admission").html('<div class="spinner-border text-light" role="status"></div>');
                    },
                    success: function () {
                        $("#_submit_btn_admission").attr("disabled", false);
                        $("#_submit_btn_admission").html(form_submit_text);
        ...
        $('.phone_number').keypress(function(event) {
            ...
            if (!(keyCode >= 48 && keyCode <= 57) && keyCode != 8 && keyCode != 43 && keyCode != 45) {
