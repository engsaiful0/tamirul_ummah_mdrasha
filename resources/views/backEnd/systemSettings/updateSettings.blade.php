                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-20 cust-lawngreen">@lang('system_settings.upload_from_local_directory')</h3>
                            </div>
                                ...
                                <div class="add-visitor">
                                    ...
                                    <table style="width:100%; box-shadow: none;" class="table school-table-style">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="https://codecanyon.net/user/codethemes/portfolio" target="_blank"> <i class="ti ti-external-link"> </i> Update </a> </td>
                                        </tr> 
                                        <tr>
