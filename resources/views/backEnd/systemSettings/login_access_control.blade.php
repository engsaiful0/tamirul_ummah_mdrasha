                                            ...
                                            <div class="row mt-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <button type="submit" class="primary-btn small tr-bg icon-only mt-10"
                                                        ...
                                                        <span class="ti-device-floppy"></span>
                                                    </button>
                                                    ...
                                                    <button data-toggle="tooltip" title="Reset Password as Default"
                                                        ...
                                                        onclick="changePassword({{@$student->user_id ? $student->user_id : 'null'}},{{@$role}})">
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            <div class="row mt-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <button data-toggle="tooltip" title="Reset Password as Default"
                                                        type="button" class="primary-btn small tr-bg icon-only mt-10"
                                                        onclick="changePassword({{@$student->parents && $student->parents->user_id ? $student->parents->user_id : 'null'}},{{@$role}})">
                                                        <span class="ti-reload"></span>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <td style="white-space: nowrap;">
                                            ...
                                            <div class="row mt-10">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <button data-toggle="tooltip" title="Reset Password as Default"
                                                        type="button" class="primary-btn small tr-bg icon-only mt-10"
                                                        onclick="changePassword({{@$value->user_id ? $value->user_id : 'null'}},{{@$role}})">
                                                        <span class="ti-reload"></span>
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <table id="table_id" class="table data-table Crm_table_active3 no-footer dtr-inline collapsed"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>@lang('student.fathers_email') </th>
                                        <th>@lang('student.mother_name') </th>
                                        <th>@lang('student.mother_phone') </th>
                                        <th>@lang('student.mothers_email') </th>
                                        <th>@lang('rolepermission::role.login_permission')</th>
                                        <th style="width: 200px;">@lang('common.password')</th>
                                    </tr>
                                </thead>

                                <tbody>
                                    @foreach($parents as $parent)
                                    <tr id="{{@$parent->user_id ? $parent->user_id : ''}}">
                                        <input type="hidden" id="id" value="{{@$parent->user_id ? $parent->user_id : ''}}">
                                        <input type="hidden" id="role" value="{{@$role}}">
                                        <td>{{@$parent->guardians_mobile}}</td>
                                        <td>{{@$parent->fathers_name}}</td>
                                        <td>{{@$parent->fathers_mobile}}</td>
                                        <td>{{@$parent->fathers_email}}</td>
                                        <td>{{@$parent->mothers_name}}</td>
                                        <td>{{@$parent->mothers_mobile}}</td>
                                        <td>{{@$parent->mothers_email}}</td>
                                        <td>
                                            @if(@$parent->user_id && @$parent->parent_user)
                                            @php
                                            if(@$parent->parent_user->access_status == 0){
                                            $permission_id='login-access-control-on';
                                            }else{
                                            $permission_id='login-access-control-off';
                                            }
                                            ...
                                            @endif
                                            @else
                                            <span class="text-danger" data-toggle="tooltip" title="No user account linked to this parent">
                                                <i class="ti-alert"></i> No Account
                                            </span>
                                            @endif
                                        </td>
                                        <td style="white-space: nowrap;">
                                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'reset-student-password', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                            <input type="hidden" name="id" value="{{@$parent->user_id}}">
                                            <div class="row mt-10">
                                                <div class="col-lg-6">
                                                    <div class="primary_input md_mb_20">
                                                        <input class="primary_input_field read-only-input" type="text"
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <button data-toggle="tooltip" title="Reset Password as Default"
                                                        type="button" class="primary-btn small tr-bg icon-only mt-10"
                                                        @if(@$parent->user_id)
                                                        onclick="changePassword({{@$parent->user_id}},{{@$role}})"
                                                        @else
                                                        onclick="toastr.error('No user account linked to this parent', 'Error Alert', {timeOut: 5000}); return false;"
                                                        @endif
                                                        >
                                                        <span class="ti-reload"></span>
                                                    </button>
