    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="bc-pages">
                ...
                <a href="#">@lang('common.system_settings')</a> 
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-20">@lang('system_settings.change_logo')</h3>
                        </div>
                ...
                <div class="row mt-40">
                    <div class="col-lg-12">
                        <div class="main-title">
                            ...
                            <h3 class="mb-20">@lang('system_settings.change_fav') </h3>
                        </div>
            ...
            <div class="col-lg-8 col-xl-8">
                <div class="row xm_3">
                    <div class="col-lg-7 col-xl-7 no-apadmin col-sm-6">
                        <div class="main-title">
                            <h3 class="mb-20">@lang('system_settings.general_settings_view')</h3>
                        </div>
                    </div>
                            ...
                            <div class="student-meta-box">
                                ...
                                <div class="single-meta d-none">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="name">
                                                @lang('system_settings.email_footer_content') 
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="value text-left">
                                                @if(! is_null($editData->email_footer_content))
                                                {!! @$editData->email_footer_content !!}

                                                @else

                                                © 2023 Dreamsschool | Copyright © 2025 All right reserved | This application is made by Dreams Technologies
