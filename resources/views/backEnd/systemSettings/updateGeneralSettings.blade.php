                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row md-30 mt-25">
                            <div class="col-lg-12">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('system_settings.email_footer_content') <span></span> </label>
                                    <textarea class="primary_input_field form-control" cols="0" rows="4" name="email_footer_content" id="email_footer_content">{{isset($editData) ? @$editData->email_footer_content : old('email_footer_content')}}</textarea>
                                </div>
                            </div>
                        </div>
