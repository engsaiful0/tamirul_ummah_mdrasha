                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-20">@if(isset($edit_languages))
            ...
            @endif
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3>@lang('system_settings.language_list')</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <x-table>
                            <table id="table_id" class="table data-table Crm_table_active3 no-footer dtr-inline" cellspacing="0" width="100%">
                                <thead>
                                ...
                                @foreach($sms_languages as $sms_language)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- <a href="{{URL::to('/locale/'.$sms_language->language_universal)}}" class="primary-btn small tr-bg white_space"  > <span class="ti ti-check"></span> @lang('system_settings.make_default')</a>--}}
