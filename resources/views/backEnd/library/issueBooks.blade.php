    ...
    <section class="sms-breadcrumb mb-20 white-box">
        ...
        <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('submenu-list',['sub_menu' =>'library']) }}">@lang('library.library')</a>
                            ...
                            <div class="table-responsive">
                                <x-table>
                                    <table id="table_id" class="table table-type" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            @if (isset($totalIssuedBooks) && count($totalIssuedBooks) > 0)
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="6" class="text-center">@lang('common.no_data_available')</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
