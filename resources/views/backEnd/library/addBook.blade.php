          ...
          <div class="container-fluid">
            <div class="row">
                ...
                <div class="offset-lg-3 col-lg-3 text-right mb-20 col-sm-6">
                        <a href="{{ route('import_book') }}" class="primary-btn small fix-gr-bg">
                            <span class="ti ti-plus pr-2"></span>
                            @lang('library.import_book')
                        </a>
                </div>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="primary_input ">
                                        ...
                                        <input
                                            class="primary_input_field text_numbers_only form-control{{ $errors->has('book_title') ? ' is-invalid' : '' }}"
                                            type="text" name="book_title" maxlength="100" autocomplete="off"
