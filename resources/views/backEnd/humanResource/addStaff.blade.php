            ...
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <div class="main-title">
                        <h3 class="mb-20">@lang('hr.staff_information') </h3>
                    </div>
                </div>
                            ...
                            <div class="row mb-30">
                                <div class="col-lg-3">
                                    <div class="primary_input">
                                        ...
                                        <input
                                            class="primary_input_field text_only form-control {{ $errors->has('first_name') ? 'is-invalid' : ' ' }}"
                                            type="text" name="first_name" maxlength="60" value="{{ old('first_name') }}">
                                    ...
                                    <div class="primary_input">
                                        ...
                                        <div class="primary_file_uploader">
                                            <label class="switch-esi">
                                              <input type="checkbox" id="esiPf" name="esiPf" checked value="1">
