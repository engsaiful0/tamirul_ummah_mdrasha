    ...
    <section class="sms-breadcrumb mb-20 white-box">
        ...
        <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('submenu-list',['sub_menu' =>'staff_report']) }}">@lang('hr.staff_report')</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive pt-30">
                                <div id="table_id_student_wrapper" class="dataTables_wrapper no-footer table-responsive">
                                    <table id="table_id1" style="margin-bottom:25px" class="table"
