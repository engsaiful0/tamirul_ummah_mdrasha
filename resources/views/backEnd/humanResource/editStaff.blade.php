                        ...
                        <div class="white-box">
                            <div class="">
                                ...
                                <div class="row mb-30">
                                    ...
                                    @if (in_array('fathers_name', $has_permission) && Auth::user()->role_id != 0)  
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                    ...
                                    @endif 
                                    @if (in_array('mothers_name', $has_permission) && Auth::user()->role_id != 0)
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                    ...
                                    @if (in_array('date_of_birth', $has_permission) && Auth::user()->role_id != 0) 
                                    <div class="col-lg-3">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input 
                                                                class="primary_input_field primary_input_field staff_dob form-control"
                                ...
                                <div class="row mb-20">
                                    ...
                                    <div class="col-lg-6">
                                    <div class="primary_input">
                                        <label class="primary_input_label" for="">@lang('hr.esi_pf')</label>
                                        <div class="primary_file_uploader">
                                            <label class="switch-esi">
                                              <input type="checkbox" id="esiPf" name="esiPf" {{ $editData->esipf_status == 1 ? 'checked' : '' }} value="{{$editData->esipf_status}}">
                                              <span class="slider-esi round"></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-30 mt-20">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('hr.yearly_salary')
