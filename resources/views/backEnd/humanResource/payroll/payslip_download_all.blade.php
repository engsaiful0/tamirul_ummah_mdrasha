...
.table-row::after {
  ...
  @if(isset($payroll_records[0]->payslip_number) && $payroll_records[0]->payslip_number!='')
    @foreach($payroll_records as $payroll)
    <!-- table view -->
    <table style="background-color:#ffffff;padding:15px;width:100%;">
        <tbody>
            <tr>
                <td style="text-align:center;text-decoration:underline;color:#741692;font-weight:bold;">
                    @php
                    $payslip_month = \Carbon\Carbon::parse($payroll->payslip_date)->format('F Y'); // 'F' for full month name
                    @endphp
                    @lang('hr.payslip_for') {{$payslip_month}}
        ...
        <div class="column">
            <table style="width:97%;border: 1px solid #DADCE8;">
                <tr>
                    <th colspan="2" style="background-color:#E9ECEF;padding:15px;">
                        <p style="margin:0;color:#741692;font-weight:bold;">Earnings   
                    </th>
                </tr>
                @php
            ...
            <div class="column">
                <table style="width:92%;border: 1px solid #DADCE8;">
                    <tr>
                        <th colspan="2" style="background-color:#E9ECEF;padding:15px;">
                            <p style="color:#741692;font-weight:bold;margin:0;">Deductions    
                        </th>
                    </tr>
                    @php
