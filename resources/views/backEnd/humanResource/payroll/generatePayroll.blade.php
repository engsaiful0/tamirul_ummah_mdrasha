            ...
            <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-20">@lang('hr.generate_payroll')</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <td width="100%" class="pr-30 d-block">
                                        <div class="primary_input mt-30">
                                            <label for="leave_deduction">@lang('hr.leave') @lang('hr.deduction')
                                                ({{ generalSetting()->currency_symbol }})</label>
                                                 @php
                                                    $basic_salary = is_numeric($staffDetails->basic_salary) ? $staffDetails->basic_salary : 0;
                                                    $extra_days = is_numeric($extra_days) ? $extra_days : 0;
                                                    $leave_deduction = round(($basic_salary / 30) * $extra_days);
                                                @endphp
                                            <input class="primary_input_field form-control" type="text" readonly
                                                id="leave_deduction"
