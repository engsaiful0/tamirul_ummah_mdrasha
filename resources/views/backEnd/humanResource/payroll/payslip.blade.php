            ...
            <div class="white-box w-100">
                ...
                <div class="row mt-20">
                    ...
                    <div class="col-lg-6">
                        ...
                        <!-- Other Deduction -->
                        <div class="earning-section d-none">
                            <div class="earning-title p-15">
                           ...
                           <div class="earning-body-hr">
                                <div class="d-flex align-items-center justify-content-between p-10">
                                    <p class="total-earnings font-weight-bold">Total Deductions</p>
                                    <p class="total-earnings font-weight-bold">{{ generalSetting() ? generalSetting()->currency_symbol : ''}} {{ number_format((float)$total_other_deductions, 2, '.', '') }}
                                    </p>
                                </div>    
                            </div>  
                            <!-- deduction -->  
