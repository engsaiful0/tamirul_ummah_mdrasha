...
@section('mainContent')
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="primary_select  form-control" name="role_id" id="role_id_fltr">
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <div class="primary_input">
                                    ...
                                    <input class="primary_input_field" type="text" id="staff_no_fltr" placeholder=" @lang('hr.search_by_staff_id')"
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <div class="primary_input">
                                    ...
                                    <input class="primary_input_field" type="text" id="staff_name_fltr" placeholder="@lang('common.search_by_name')"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group d-block">
                                        ...
                                        <select class="nice-select primary_select form-control" id="setting-percentage">
                                            <option>Best Performance</option>
                                            <option>Good Attendance </option>
                                            <option>Bonus</option>
                                            <option>Yearly Performance</option>
                                            <option>Topper of School</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group d-block mt-20">
                                        ...
                                        <input type="text" class="primary_input_field form-control" placeholder="Enter Name">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group d-block">
    ...
    <!-- Download Payslip fields Modal-->
    <div class="modal fade" id="payslipModal" tabindex="-1" role="dialog" aria-labelledby="payslipModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="payslipModalLabel">Download Payslip</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'download_emp_payslip', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'target' =>'_blank']) }}
                        <input type="hidden" name="emp_id" id="emp_id" value="">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group d-block">
                                        <label for="setting-percentage">Payslip for</label>
                                        <select class="nice-select primary_select form-control" id="setting-percentage" name="month">
                                ...
                                <div class="col-lg-12 mt-40">
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="primary-btn tr-bg w-50 mr-10" data-dismiss="modal">Cancel</button>
                                        <button class="primary-btn fix-gr-bg submit w-50" id="save_button_query" type="submit">Download</button>
                                    </div>
                                </div>        
                            </div>    
                        </div>    
   ...
   $(document).ready(function() {
       $('.data-table').DataTable({
                     ...
                     "ajax": $.fn.dataTable.pipeline( {
                           ...
                           data: { 
                                staff_name: $('#staff_name_fltr').val(),
                                staff_no: $('#staff_no_fltr').val(),
                                role_id: $('#role_id_fltr').val()
                            },
