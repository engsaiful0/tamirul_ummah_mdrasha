...
@endsection
@section('mainContent')
@php  @$currency = generalSetting() ? generalSetting()->currency_symbol : ''; @endphp
        ...
        <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field text_numbers_only form-control{{ @$errors->has('name') ? ' is-invalid' : '' }}"
                                                type="text" name="name" maxlength="60" autocomplete="off" value="{{isset($add_expense)? $add_expense->name: old('name')}}">
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <div class="col-lg-8 text-md-right text-left col-md-6 mb-30-lg col-sm-6 text_sm_right">
                        <a href="{{route('chart-of-account')}}" class="primary-btn small fix-gr-bg">
                            <span class="ti ti-plus pr-2"></span>
                            @lang('accounts.add_expense_type')
                        </a>
                    </div>
                </div>
