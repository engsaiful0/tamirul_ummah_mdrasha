...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="fees-btn">
        <a class="collect-fees eduction-fess active" href="{{route('bank-account')}}">@lang('accounts.bank_account') </a>
        <a class="collect-fees transport-fess" href="{{route('upi-account')}}">@lang('accounts.upi_account')</a> 
    </div>
</section>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field alphabets_only form-control{{ @$errors->has('bank_name') ? ' is-invalid' : '' }}" type="text" name="bank_name" autocomplete="off" value="{{isset($bank_account)? $bank_account->bank_name : old('bank_name')}}">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field alphabets_only form-control{{ @$errors->has('account_name') ? ' is-invalid' : '' }}" type="text" name="account_name" autocomplete="off" value="{{isset($bank_account)? $bank_account->account_name:old('account_name')}}">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field numeric-input form-control{{ @$errors->has('account_number') ? ' is-invalid' : '' }}" type="tel" name="account_number" autocomplete="off" value="{{isset($bank_account)? $bank_account->account_number:old('account_number')}}">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field alphabets_only form-control{{ @$errors->has('account_type') ? ' is-invalid' : '' }}" type="text" name="account_type" autocomplete="off" value="{{isset($bank_account)? $bank_account->account_type:old('account_type')}}">
...
@section('script')
    <script>
        ...
        $('.alphabets_only').on('keypress', function (event) {
