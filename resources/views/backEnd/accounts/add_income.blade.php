                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-20">@if(isset($add_income))
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field text_numbers_only form-control{{ @$errors->has('name') ? ' is-invalid' : '' }}"
                                                type="text" name="name" maxlength="60" autocomplete="off" value="{{isset($add_income)? $add_income->name: old('name')}}">
