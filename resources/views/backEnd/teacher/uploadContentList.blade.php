        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('submenu-list',['sub_menu' =>'study_material']) }}">@lang('study.study_material')</a>
                                    ...
                                    <div class="row mb-25">
                                        <div class="col-lg-12 mb-30">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    class="primary_input_field text_numbers_only form-control{{ $errors->has('content_title') ? ' is-invalid' : '' }}"
                                                    type="text" name="content_title" maxlength="100" autocomplete="off"
