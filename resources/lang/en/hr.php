...
return [
    ...
    'yearly_salary'=> 'CTC (Yearly Salary)',
    'earnings'=> 'Earnings',
    ...
    'epf_no'=> 'National Identification Number',
    ...
    'point2' => 'Duplicate "<strong>Staff No</strong>" (unique in section) rows will not be imported and <strong>would be number</strong>',
    ...
    'point10' => 'If the column you are trying to import is date make sure that is formatted in format Y-m-d (2018-06-06) or d-m-Y (06-06-2018).',
    'point11' => 'Duplicate "<strong>Email</strong>" (unique in section) rows will not be imported',
    ...
    'medical'=>'Medical',
    'other_allawance'=>'Other Allawance',
    'performance_allawance'=>'Performance Allawance',
    'tds'=>'TDS',
    'esi'=>'ESI',
    'other_deduction'=>'Other Deduction - LOAN',
    ...
    'epf_remitted'=>'EPF CONTRI REMITTED',
    'eps_remitted'=>'EPS CONTRI REMITTED',
    'epf_eps_diff'=>'EPF EPS DIFF REMITTED',
    'ncp_days'=>'NCP DAYS',
    'refund_advance'=>'REFUND OF ADVANCES',
    'payroll1'=> 'Payroll TESTING',
    'download_epf'=> 'Download EPF',
