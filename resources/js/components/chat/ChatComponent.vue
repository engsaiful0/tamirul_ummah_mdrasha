                    ...
                    <div class="chat_input_box d-flex align-items-center">
                        ...
                        <div class="input-group ">
                            ...
                            <div class="input-group-append">
                                <button class="btn pr-2" type="button" @click="toggleRecording" :title="__('voice_recording')">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="20" height="20">
                                        <path :style="{ fill: record_status ? '#e74c3c' : '#989898' }"
                                              d="M20 8a5 5 0 0 0-5 5v6a5 5 0 0 0 10 0v-6a5 5 0 0 0-5-5zm0 2a3 3 0 0 1 3 3v6a3 3 0 0 1-6 0v-6a3 3 0 0 1 3-3zm0 16c-5 0-9-4-9-9v-2h2v2c0 3.9 3.1 7 7 7s7-3.1 7-7v-2h2v2c0 5-4 9-9 9zm0 2v4h-2v2h4v-2h-2z"/>
                                    </svg>
                                </button>
                                <button class="btn" type="button" @click="emoji = !emoji" :title="__('emoji')">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="20" height="20">
                                        <circle :style="{ fill: emoji ? '#4CAF50' : '#989898' }" cx="20" cy="20" r="12"/>
                                        <path fill="#fff" d="M14 22s1.5 2 6 2 6-2 6-2"/>
                                        <circle fill="#fff" cx="16" cy="16" r="2"/>
                                        <circle fill="#fff" cx="24" cy="16" r="2"/>
                                    </svg>
                                </button>
                                <button v-show="can_file_upload" class="btn" type="button" :title="__('attach_file')" style="position: relative;">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="20" height="20">
                                        <path fill="#989898"
                                              d="M22 10v14a4 4 0 0 1-8 0V12a3 3 0 0 1 6 0v10a1 1 0 0 1-2 0V12h-2v10a3 3 0 0 0 6 0V12a5 5 0 0 0-10 0v12a6 6 0 0 0 12 0V10z"/>
                                    </svg>
                                    <input type="file" @change="onFileChange" id="imgInp" ref="file"
                                        v-on:change="onChangeFileUpload()"
                                        accept=".jpg,.jpeg,.png,.doc,.docx,.pdf,.mp4,.3gp,.webm" style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0;cursor:pointer;">
                                </button>
