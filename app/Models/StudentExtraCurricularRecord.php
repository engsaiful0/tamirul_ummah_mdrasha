...
class StudentExtraCurricularRecord extends Model
{
    use HasFactory;
    protected $guarded = [
        'id'
    ...
    {
        return $this->belongsTo('App\SmClass', 'extra_class_id', 'id')->withDefault()->withoutGlobalScope(StatusAcademicSchoolScope::class);
    }    
    ...
    {
        return $this->belongsTo(SmExtraCurricularClass::class, 'extra_class_id','id');
    }
    ...
    {
        return $this->hasMany(SmExtraclassFees::class, 'extra_curricular_record_id', 'id');
    }
