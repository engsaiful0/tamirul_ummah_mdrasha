...
class StudentRecord extends Model
{
    ...
    public function studentDetailTransport()
    {
        return $this->belongsTo('App\SmStudent', 'student_id', 'id')->whereNotNull('route_list_id');
    }
    ...
    public static function getStudentclass1($class_id)
    {        
    ...
    public static function getStudentSection($section_id)
    {        
        $section = DB::table('sm_sections')->where('active_status',1)
                        ->where('id', $section_id)
                        ->first();
        return $section;
    }
