...
class SmStudentAdmissionController extends Controller
{
    ...
    public function studentStore(Request $request)
    {
        ...
        try {
            ...
            try {
                $userIdParent = null;
                if ($request->parent_id == "" && !empty($request->mothers_email)) {
                    ...
                    $data_parent['email'] = $request->mothers_email;
                    $user_parent->username = $request->mothers_email;
                    $user_parent->email = $request->mothers_email;
                        ...
                        try {
                            ...
                            try {
                                ...
                                if ($mother_email) {
                                    ...
                                    $user_parent->username = $mother_email;
    ...
    public function allStudentExportPdf()
    {
        try{
            ...
            $pdf = PDF::loadView('backEnd.studentInformation.allStudentExportPdfPrint', compact('students','academiYear'));
    ...
    public function extraClassSortingStudent($class_id)
    {
        try {
            $class = SmExtraCurricularClass::find($class_id);
            $pt = trans('student.class') . " ". @$class->class_name . " ". trans('student.student_list');
            return view('backEnd.studentInformation.extraCurricular.sortingExtraClassStudent', compact('class_id','pt'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
