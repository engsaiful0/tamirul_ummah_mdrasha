...
class SmLeaveDefineController extends Controller
{
    ...
    public function store(SmLeaveDefineRequest $request)
    {
        try{
            ...
            // Leave type already exists validation for staff/student wise

            if($request->student!=""){
                $is_duplicate =  SmLeaveDefine::where('type_id',$request->leave_type)
            ...
            if ($is_duplicate) {
                Toastr::error('This Leave type already exists for this user!', 'Failed');
