    ...
    public function store(ClassRequest $request)
    {
       // DB::beginTransaction();
            try {
                ...
                //Extra curricular class fee settings
                $extra_classes = SmExtraCurricularClass::get();
                foreach($extra_classes as $class){
                    $extra_curricular_fees_assigns = SmExtraCurricularFeesSettings::where('class_id', $class_id)
                    ->where('extra_class_id', $class->id)
                    ...
                    if(!$extra_curricular_fees_assigns){
                        ...
                        $extra_curricular_fees_assigns->class_id = $class_id;
                        $extra_curricular_fees_assigns->extra_class_id = $class->id;
