...
class SmStaffController extends Controller
{
    ...
    public function staffStore(staffRequest $request)
    {
        ...
        try {
            ...
            try {
                ...
                $staff->esipf_status = !empty($request->esiPf) ? $request->esiPf : 0;
                //Custom Field End
                $results = $staff->save();
                $staff->toArray();
                DB::commit();
    ...
    public function payrollStaffList(Request $request)
    {  
        try {
            if (Auth::user()->role_id == 1) {
            ...
            $salary = 900000;
            $res = $this->payrollCalculation($salary);
            print_r($res);
            echo "TEST";
            exit;
