...
class SmSearchFeesPaymentController extends Controller
{
    ...
    public function searchextrafeespage(Request $request)
    {
        try {
            if(auth()->user()->role_id ==1 || auth()->user()->role_id ==5){
                $fees_payments = SmFeesPayment::with('recordDetail','installmentPayment','recordDetail.studentDetail','recordDetail.class','recordDetail.section')
            ...
            $extra_classes = SmExtraCurricularClass::where('active_status', 1)
                        ->where('school_id',Auth::user()->school_id)
                        ->where('academic_id', getAcademicId())
                        ->get();

            $invoice_setting = FeesInvoice::where('school_id', auth()->user()->school_id)->first(['prefix','start_form']);
            return view('backEnd.feesCollection.search_extra_fees_payment', compact('classes','fees_payments','invoice_setting','extra_classes'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function extrafeessearch(SmFeesCollectSearchRequest $request)
    {      
        ...
        try {
            ...
            $search['date_to']    = $request->date_to;
            $search['class']  = $request->class;
            $search['extra_class']  = $request->extra_class;
            $search['keyword']  = $request->keyword;
            $search['pay_mode']  = $request->payment_mode;
            $invoice_setting = FeesInvoice::where('school_id', auth()->user()->school_id)->first(['prefix','start_form']);
            return view('backEnd.feesCollection.search_extra_fees_payment', compact('classes','invoice_setting','extra_classes'))->with($search);
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function searchextrafeesduepage(Request $request)
    {
        try {
            ...
            $invoice_setting = FeesInvoice::where('school_id', auth()->user()->school_id)->first(['prefix','start_form']);
            return view('backEnd.feesCollection.search_extra_fees_due', compact('classes','invoice_setting','extra_classes'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
    ...
    public function extraduesearch(SmFeesCollectSearchRequest $request)
    {      
        ...
        try {
            ...
            $search['keyword']  = $request->keyword;
            $invoice_setting = FeesInvoice::where('school_id', auth()->user()->school_id)->first(['prefix','start_form']);
            return view('backEnd.feesCollection.search_extra_fees_due', compact('classes','invoice_setting','extra_classes'))->with($search);
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
