            ...
            elseif(directFees()){
                ...
                foreach ($students as $key => $student) {
                    ...
                    if ($total_amount > $total_paid) {
                        ...
                        if(isset($student->feesPayment[$key]) && $student->feesPayment[$key]!='') {
                            $fees_created_by = User::find($student->feesPayment[$key]->created_by);
                        }

                        $data[$key]['totalFine'] = $totalFine;
                        $data[$key]['totalDeposit'] = $totalDeposit;
                        $data[$key]['totalFees'] = $totalFees;
                        $data[$key]['fees_created_by'] = isset($fees_created_by->full_name) ? $fees_created_by->full_name : '-';
