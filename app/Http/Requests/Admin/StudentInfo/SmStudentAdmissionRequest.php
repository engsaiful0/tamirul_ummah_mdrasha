...
class SmStudentAdmissionRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules= [
            ...
            'fathers_email'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && !$this->staff_parent && in_array('fathers_email', $field);
            ...
            'mothers_email'=>[Rule::requiredIf(function () use ($field) {
                return !$this->parent_id && !$this->staff_parent && in_array('mothers_email', $field);
            }),'nullable','email','max:200'],
        ...
        if ($user_role_id !=2) {
            $rules +=[
                ...
                'roll_number' => ['numeric','min:1','sometimes', 'nullable', Rule::requiredIf(function () use ($field) {
