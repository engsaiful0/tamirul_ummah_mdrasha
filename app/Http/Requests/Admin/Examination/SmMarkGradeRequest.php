...
class SmMarkGradeRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if(generalSetting()->result_type != 'mark'){
            return [
                'grade_name' => ['required', 'max:50', Rule::unique('sm_marks_grades')->where('school_id', $school_id)->ignore($this->id ? $this->id : null)],
                'gpa' => ['required', Rule::unique('sm_marks_grades')->where('school_id', $school_id)->ignore($this->id ? $this->id : null)],
