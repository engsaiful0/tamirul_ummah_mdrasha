                        ...
                        <div class="closed_section" data-id="{{ $sidebar_menu->id }}"
                            ...
                            <div id="accordion" class="dd">
                                <div class="section_nav">
                                    <h5>{{ $sidebar_menu->permissionInfo->name == 'Online Exam ' ? 'CBT' : $sidebar_menu->permissionInfo->name }}                                    </h5>
                                                                ...
                                                                <div class="card accordion_card"
                                                                    ...
                                                                    <div class="card-header item_header"
                                                                        ...
                                                                        <div class="dd-handle">
                                                                            ...
                                                                            {{ $menu->permissionInfo->name == 'Online Exam ' ? 'CBT' : $menu->permissionInfo->name }}
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <li class="dd-item" data-id="{{ $submenu->id }}"
                                                                            ...
                                                                            <div class="card accordion_card"
                                                                                ...
                                                                                <div class="card-header item_header"
                                                                                    ...
                                                                                    <div class="dd-handle">
                                                                                        <div class="float-left">
                                                                                            @if($submenu->permissionInfo->name == 'Online Exam' || $submenu->permissionInfo->name == 'Online Exam ')
                                                                                            {{ 'CBT' }}
                                                                                            @elseif($submenu->permissionInfo->name == 'Online Exam Report')
                                                                                            {{ 'CBT Report' }}
                                                                                            @else
