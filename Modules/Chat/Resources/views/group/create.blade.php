                        ...
                        <div class="chat_flow_list_wrapper ">
                            <div class="box_header">
                                ...
                                @if(userPermission(902))
                                    <a class="primary-btn radius_30px  fix-gr-bg" href="{{ route('chat.new') }}"><i class="ti ti-plus"></i>@lang('chat::chat.new_chat')</a>
                                @endif
                            </div>
                            <!-- chat_list  -->
                                ...
                                <form action="{{ route('chat.group.create') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="chat_view_list_inner_scrolled" style="overflow: unset;">
                                        <div class="primary_input">
                                            ...
                                            <input class="primary_input_field text_numbers_only" placeholder="-" type="text" name="name" required>
                                        </div>
