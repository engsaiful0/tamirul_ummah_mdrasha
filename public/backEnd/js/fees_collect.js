            ...
            $.ajax({
                ...
                success: function (data) {                    
                    ...
                    if (data['success'] == 'success') {
                        ...
                        <td><span class="mr-2">$${ data['fees'].amount}</span><i class="ti ti-trash click" onclick="deleteDiscount(${data['fees'].id})"></i></td></tr>`)
            ...
            $.ajax({
                ...
                success: function (data) {                                        
                    ...
                    if (data['success'] == 'success') {
                        ...
                        <td>${ data['fees'].name}</td>
                        <td>$${ data['fees'].amount}  <i class="ti ti-trash click" onclick="deleteFine(${data['fees'].id})"></i></td></tr>`)
                    } else if(data['error'] == 'used') {
                        toastr.error('Already discount used!')
                    } else if(data['error'] == 'error') {
                        toastr.error('Operation faild!')
