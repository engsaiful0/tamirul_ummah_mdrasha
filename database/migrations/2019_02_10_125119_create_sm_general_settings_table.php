...
class CreateSmGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('sm_general_settings')->insert([
            [
                'copyright_text' => 'Copyright &copy; '.date('Y').' All rights reserved | This application is made by Dreams Technologies',
                'logo' => 'public/uploads/settings/logo.png',
                'favicon' => 'public/uploads/settings/favicon.png',
                'phone' => '+2348072868289',
                'school_code' => '12345678',
                'email' => 'edsereltd@gmail.com',
                'address' => '3, Bright-Ese street, Evbukhu, off Sapele Road, Benin city, Edo state.',
                'currency' => 'naira',
                'currency_symbol' => '₦',
                'school_name' => 'School',
                'site_title' => 'Education software',
                'session_id' => 1,
                'week_start_id' => 3,
                'time_zone_id' => 51,
                'software_version' => '10.31.0',
