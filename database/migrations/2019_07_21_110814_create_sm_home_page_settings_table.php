...
class CreateSmHomePageSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $s->long_title = 'School';
        $s->short_description = 'Managing various administrative tasks in one place is now quite easy and time savior with this School and Give your valued time to your institute that will increase next generation productivity for our society.';
        $s->link_label = 'Learn More About Us';
        $s->link_url = 'https://school.dreamstechnologies.com/about';
        $s->image = 'public/frontend/theme/images/banner6.png';
        $s->save();
    } 
    /**
