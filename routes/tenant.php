...
Route::get('school-register', '\App\Http\Controllers\SuperAdmin\SuperAdminController@schoolRegister');
Route::post('school-register', 'SuperAdmin\SuperAdminController@customer_register')->name('school-register');


Route::group(['middleware' => []] ,function(){
    Route::get('/library-resource', 'LibraryResourceController@index')->name('library-resource');
    ...
    Route::get('signup/', 'SmFrontendController@signup')->name('/');
    Route::post('schoolregister', 'SmFrontendController@school_register')->name('school_register');
    ...
    Route::get('contact', 'SmFrontendController@contact')->name('contact');;

    //Send contact mail
    Route::post('contact-mail', 'SmFrontendController@sendContactMail')->name('contact-mail');
    ...
    Route::post('admin-change-password', 'HomeController@updatePassowrdStore')->name('updatePassowrdStore');

    Route::get('change-email', 'HomeController@updateEmail')->name('updateEmail');
    Route::post('change-email', 'HomeController@updateEmailStore')->name('updateEmailStore');
    Route::post('update-profile-picture', 'HomeController@updateProfilePicture')->name('updateProfilePicture');
