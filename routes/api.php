...
Route::post('get-full-domain-url', 'SmApiController@getFullDomainUrl');
// Route::post('system-disable', 'SmApiController@systemDisbale');
    
    Route::get('service/check', 'api\checkService\CheckController@index');
   ...
   // admin section visitor
    ...
    Route::any('admin-dashboard-details/{school_id}', 'SmApiController@adminDashboardDetails');
...
Route::group(['middleware' => ['XSS','auth:api','json.response']], function () {
    ...
    Route::get('subject-by-class-section/{id}/{class_id}/{section_id}', 'SmApiController@subjectsNameTeacher');
   ...
   Route::get('pending-leave/{user_id}', 'api\ApiSmLeaveController@pendingLeave');
    ...
    Route::get('upi-list', 'SmApiController@upiList');
