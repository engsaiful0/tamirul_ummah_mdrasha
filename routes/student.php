...
Route::group(['middleware' => ['XSS', 'subdomain']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        Route::get('student-dashboard', 'Student\SmStudentPanelController@studentDashboard')->name('student-dashboard');
        ...
        Route::get('progress-card-report', ['as' => 'progress-card-report', 'uses' => 'Student\SmStudentPanelController@progressCardReport'])->middleware('userRolePermission:progress-card-report');
        Route::post('progress-card-report', ['as' => 'progress-card-report-search', 'uses' => 'Student\SmStudentPanelController@progressCardReportSearch']);
