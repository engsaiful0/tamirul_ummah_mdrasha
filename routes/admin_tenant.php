...
Route::get('php_migrate','Auth\LoginController@migrate_command');
...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        /********************* Menu List ************************************/
        Route::get('/submenu-list', 'HomeController@menuList')->name('submenu-list');

         //Route::get('submenu-list/{menu_id}', ['as' => 'submenu-list', 'uses' => 'HomeController@menuList'])->name('submenu-list');
        ...
        Route::get('school_list', ['as' => 'school_list', 'uses' => 'SuperAdmin\SuperAdminController@school_list']);

        Route::get('school-payment-status/{id}', ['as' => 'school_payment_status', 'uses' => 'SuperAdmin\SuperAdminController@paidStatus']);
        Route::get('school-active-status/{id}', ['as' => 'school_active_status', 'uses' => 'SuperAdmin\SuperAdminController@activeStatus']);


        Route::post('school_list', 'SuperAdmin\SuperAdminController@schoolQuerySearch')->name('school-query-search');


        Route::get('new_schools', ['as' => 'new_schools', 'uses' => 'SuperAdmin\SuperAdminController@new_schools']);
        ...
        Route::get('login-otp', 'EmailOtpController@emailOtpFrom')->name('login-otp');
        Route::get('enter-otp', 'EmailOtpController@enterOtpFrom')->name('enter-otp');
        Route::post('generate-otp', 'EmailOtpController@generate')->name('generate-otp');
        Route::post('verify-otp', 'EmailOtpController@verify')->name('verify-otp');
        ...
        Route::get('extra-curricular', ['as' => 'extra-curricular', 'uses' => 'Admin\Academics\SmExtraClassController@index'])->middleware('userRolePermission:extra-curricular');

        //Route::get('extra-curricular', ['as' => 'extra-curricular', 'uses' => 'Admin\Academics\SmExtraClassController@index'])->middleware('userRolePermission:class');
         Route::post('extra-class-store', ['as' => 'extra_class_store', 'uses' => 'Admin\Academics\SmExtraClassController@store'])->middleware('userRolePermission:extra_class_store');
         Route::get('extra-class-edit/{id}', ['as' => 'extra_class_edit', 'uses' => 'Admin\Academics\SmExtraClassController@edit'])->middleware('userRolePermission:class_edit');
         Route::post('extra-class-update', ['as' => 'extra_class_update', 'uses' => 'Admin\Academics\SmExtraClassController@update'])->middleware('userRolePermission:class_edit');
         Route::get('extra-class-delete/{id}', ['as' => 'extra_class_delete', 'uses' => 'Admin\Academics\SmExtraClassController@delete'])->middleware('userRolePermission:class_delete');
        ...
        Route::get('subject-attendance-search', 'Admin\StudentInfo\SmSubjectAttendanceController@index');
        ...
        //Fees extra class assign
        Route::get('fees-extra-class', 'Admin\FeesCollection\SmFeesExtraClassController@feesExtraClassAssign')->name('fees_extra_class')->middleware('userRolePermission:fees_extra_class');

        Route::post('fees-extraclass-assign-search', 'Admin\FeesCollection\SmFeesExtraClassController@feesExtraClassAssignSearch')->name('fees-extraclass-assign-search');

        Route::post('fees-extraclass-assign-store', 'Admin\FeesCollection\SmFeesExtraClassController@feesExtraClassAssignStore');

        //Collect Extra Curricular Fees 
        Route::get('collect-extraclass-fees', 'Admin\FeesCollection\SmExtraCurricularFeesCollectController@index')->name('collect_extraclass_fees')->middleware('userRolePermission:collect_extraclass_fees');

        Route::post('collect-extraclass-fees', ['as' => 'collect-extraclass-fees', 'uses' => 'Admin\FeesCollection\SmExtraCurricularFeesCollectController@search']);

        Route::get('extraclass-fees-collect-student-wise/{id}', ['as' => 'extraclass_fees_collect_student_wise', 'uses' => 'Admin\FeesCollection\SmExtraCurricularFeesCollectController@collectFeesStudent'])->where('id', '[0-9]+')->middleware('userRolePermission:110');


        Route::get('extraclass-fees-generate-modal/{amount}/{student_id}/{assign_id}/{record_id}', 'Admin\FeesCollection\SmExtraCurricularFeesController@feesGenerateModal')->name('extraclass-fees-generate-modal')->middleware('userRolePermission:extraclass-fees-generate-modal');

        //Quick payment
        Route::get('quick-payment', 'Admin\FeesCollection\SmQuickFeesCollectionController@index')->name('quick_payment')->middleware('userRolePermission:quick_payment');

        Route::get('payment-details', 'Admin\FeesCollection\SmQuickFeesCollectionController@feeDetails')->name('student.payment-details');

        // Route::get('fees-transport-modal/', 'Admin\FeesCollection\SmQuickFeesCollectionController@feesGenerateModal')->name('fees-transport-modal');

        Route::post('fees-transport-status', 'Admin\FeesCollection\SmQuickFeesCollectionController@updateTransportFeeStatus')->name('fees-transport-status');


        Route::post('student-save-billing', 'Admin\FeesCollection\SmQuickFeesCollectionController@feesPaymentStore')->name('student.save-billing');

        Route::post('save-transport-billing', 'Admin\FeesCollection\SmQuickFeesCollectionController@transportFeesPaymentStore')->name('student.save-transport-billing');



        //fees payment store
        Route::post('extraclass-fees-payment-store', 'Admin\FeesCollection\SmExtraCurricularFeesController@feesPaymentStore')->name('extraclass-fees-payment-store');

        //Extra curricular fees print
        Route::get('extraclass-fees-payment-invoice-print/{id}/{group}', ['as' => 'extraclass_fees_payment_invoice_print', 'uses' => 'Admin\FeesCollection\SmExtraCurricularFeesController@feesPaymentInvoicePrint']);
        ...
        // Transport Fees 
        Route::get('collect-transport-fees', ['as' => 'collect_transport_fees', 'uses' => 'Admin\FeesCollection\SmFeesCollectController@transportFees'])->middleware('userRolePermission:collect_transport_fees');
        Route::post('collect-transport-fees', ['as' => 'collect_transport_fees', 'uses' => 'Admin\FeesCollection\SmFeesCollectController@transportSearch']);
        ...
        Route::get('transport-fees-collect-student-wise/{id}', ['as' => 'transport_fees_collect_student_wise', 'uses' => 'Admin\FeesCollection\SmFeesCollectController@collectTransportFeesStudent'])->where('id', '[0-9]+')->middleware('userRolePermission:110');

        Route::get('transport-fees-generate-modal/{amount}/{student_id}/{month_id}/{month}/{record_id}/{route_id}/{fee_amount}', 'Admin\FeesCollection\SmFeesController@transportFeesGenerateModal')->name('transport-fees-generate-modal')->middleware('userRolePermission:transport-fees-generate-modal');
        Route::post('transport-fees-payment-store', 'Admin\FeesCollection\SmFeesController@transportFeesPaymentStore')->name('transport-fees-payment-store');

        Route::get('transport-fees-payment-invoice-print/{id}/{group}', ['as' => 'transport_fees_payment_invoice_print', 'uses' => 'Admin\FeesCollection\SmFeesController@transportFeesPaymentInvoicePrint']);
        ...
        // Search Extra Fees Payment
        Route::get('search-extra-fees-payment', ['as' => 'search_extra_fees_payment', 'uses' => 'Admin\FeesCollection\SmSearchFeesPaymentController@searchextrafeespage'])->middleware('userRolePermission:search_fees_payment');
        Route::post('extra-fees-payment-search', ['as' => 'extra_fees_payment_search', 'uses' => 'Admin\FeesCollection\SmSearchFeesPaymentController@extrafeessearch']);
        Route::get('extra-fees-payment-search', ['as' => 'extra_fees_payment_search', 'uses' => 'Admin\FeesCollection\SmSearchFeesPaymentController@searchextrafeespage']);
        ...
        // Extra Fees Search due
        Route::get('search-extra-fees-due', ['as' => 'search_extra_fees_due', 'uses' => 'Admin\FeesCollection\SmSearchFeesPaymentController@searchextrafeesduepage']);
        Route::post('extra-fees-due-search', ['as' => 'extra_fees_due_search', 'uses' => 'Admin\FeesCollection\SmSearchFeesPaymentController@extraduesearch']);
        Route::get('extra-fees-due-search', ['as' => 'extra_fees_due_search', 'uses' => 'Admin\FeesCollection\SmSearchFeesPaymentController@searchextrafeesduepage']);


        Route::post('send-dues-fees-email', 'Admin\FeesCollection\SmFeesController@sendDuesFeesEmail')->name('send-dues-fees-email');

        Route::post('send-dues-extrafees-email', 'Admin\FeesCollection\SmFeesController@sendDuesExtraFeesEmail')->name('send-dues-extrafees-email');
        ...
        Route::post('extra-reject-fees-payment', 'Admin\FeesCollection\SmFeesBankPaymentController@rejectExtraFeesPayment')->name('extra-reject-fees-payment');

        Route::post('reject-bank-fees-payment', 'Admin\FeesCollection\SmFeesBankPaymentController@rejectBankFeesPayment')->name('reject-bank-fees-payment');
        ...
        Route::get('account-management', ['as' => 'account_management', 'uses' => 'Admin\Accounts\SmAccountsController@transactionManagement'])->middleware('userRolePermission:transaction');
        Route::post('account-transaction', ['as' => 'account_transaction', 'uses' => 'Admin\Accounts\SmAccountsController@accountsTransaction']);
        ...
        //Assign Route to Students
        //Route::get('assign-students/{id}', 'Admin\Transport\SmAssignVehicleController@assignStudents')->name('assign-students')->middleware('userRolePermission:assign-students');

        //Route::get('assign-students/{id}/assign', 'Admin\Transport\SmAssignVehicleController@assignStudents')->name('assign-students')->middleware('userRolePermission:assign-students');

        Route::get('assign-students/{id}', 'Admin\Transport\SmAssignVehicleController@assignStudents')->name('assign-vehicle-student')->middleware('userRolePermission:assign-vehicle-student');

        Route::post('assign-student-search', 'Admin\Transport\SmAssignVehicleController@studentsAssignSearch')->name('assign-student-search');
        Route::post('btn-assign-student-transport', 'Admin\Transport\SmAssignVehicleController@transportAssignStore');

        Route::get('route-assign-datatable', 'Admin\FeesCollection\SmFeesMasterController@routeAssignDatatable')->name('route-assign-datatable')->middleware('userRolePermission:route-assign-datatable');
        ...
        //Route::get('assign-students/{id}', ['as' => 'assign_students', 'uses' => 'Admin\Transport\SmAssignVehicleController@assignStudents']);

        Route::post('assign-students', 'Admin\Transport\SmAssignVehicleController@store')->name('assign-students')->middleware('userRolePermission:assign-students-store');
        ...
        Route::get('import-route', ['as' => 'import_route', 'uses' => 'Admin\Transport\SmRouteController@importRoute'])->middleware('userRolePermission:import_route');
        Route::get('download_route_file', ['as' => 'download_route_file', 'uses' => 'Admin\Transport\SmRouteController@downloadStudentFile']);
        Route::post('route-bulk-store', ['as' => 'route_bulk_store', 'uses' => 'Admin\Transport\SmRouteController@routeBulkStore']);
        ...
        // store online exam or CBT question
        ...
        // ->middleware('userRolePermission:online-exam-datatable');
        ...
        Route::get('upi-account', 'Admin\Accounts\SmBankAccountController@upicreation')->name('upi-account');
        Route::post('upi-account', 'Admin\Accounts\SmBankAccountController@upistore')->name('upi-account');
        Route::get('upi-account-datatable', 'Admin\Accounts\SmBankAccountController@upiAccountDatatable')->name('upi-account-datatable');
        Route::delete('upi-account-delete', 'Admin\Accounts\SmBankAccountController@destroy_upi')->name('upi-account-delete');
        // Expense head
        ...
        Route::get('/get-fees-types', 'Admin\FeesCollection\SmFeesMasterController@getFeesTypes')->name('getFeesTypes')->middleware('userRolePermission:fees-master');
        ...
        Route::get('add-ajax-fees-group', 'Admin\FeesCollection\SmFeesMasterController@addFeesGroup')->name('add-ajax-fees-group');
        Route::get('add-ajax-fees-type', 'Admin\FeesCollection\SmFeesMasterController@addFeesType')->name('add-ajax-fees-type');
       ...
       //Route::get('create-certificate', 'Admin\AdminSection\SmStudentCertificateController@createCertificate')->name('create-certificate');
        ...
        // Library Import
        Route::get('import-book', ['as' => 'import_book', 'uses' => 'Admin\Library\SmBookController@importBook']);
        Route::post('book-bulk-store', ['as' => 'book_bulk_store', 'uses' => 'Admin\Library\SmBookController@bookBulkStore']);
        ...
        //Ajax Sibling info update
        Route::get('ajaxSiblingInfoUpdate', 'Admin\StudentInfo\SmStudentAjaxController@ajaxSiblingInfoUpdate');

        Route::get('ajaxSiblingInfoSave', 'Admin\StudentInfo\SmStudentAjaxController@ajaxSiblingInfoSave');

        Route::get('ajaxClearSiblingInfo', 'Admin\StudentInfo\SmStudentAjaxController@ajaxClearSiblingInfo');

        Route::post('ajaxDeleteSibling', 'Admin\StudentInfo\SmStudentAjaxController@ajaxDeleteSibling');
        
        Route::get('ajaxLoadSiblingInfo', 'Admin\StudentInfo\SmStudentAjaxController@ajaxLoadSiblingInfo');
       ...
       // Extra curricular student list
       Route::get('extraclass-student-list-datatable', ['as' => 'extraclass_student_list_datatable', 'uses' => 'ExtraClassDatatableQueryController@studentDetailsDatatable'])->middleware('userRolePermission:student_list');
        ...
        //payroll
        Route::post('/updateCtcMonth', 'Admin\Hr\SmPayrollController@updateCtcFormat');

        Route::get('payroll-settings', ['as' => 'payroll_settings', 'uses' => 'Admin\Hr\SmPayrollController@payrollSettings'])->middleware('userRolePermission:payroll_settings');

        Route::post('payroll-earnings-store', 'Admin\Hr\SmPayrollController@payrollEarningStore');

        Route::post('payroll-deduction-store', 'Admin\Hr\SmPayrollController@payrollDeductionStore');

        Route::get('payroll-earnings-edit/{id}', ['as' => 'payroll_earnings_edit', 'uses' => 'Admin\Hr\SmPayrollController@editEarnings'])->middleware('userRolePermission:payroll_earnings_edit');

        Route::get('payroll-deductions-edit/{id}', ['as' => 'payroll_deductions_edit', 'uses' => 'Admin\Hr\SmPayrollController@editDeductions'])->middleware('userRolePermission:payroll_deductions_edit');

        Route::get('payroll-earnings-delete/{id}', ['as' => 'payroll_earnings_delete', 'uses' => 'Admin\Hr\SmPayrollController@deleteEarnings'])->middleware('userRolePermission:payroll_earnings_delete');

        Route::get('payroll-deductions-delete/{id}', ['as' => 'payroll_deductions_delete', 'uses' => 'Admin\Hr\SmPayrollController@deleteDeductions'])->middleware('userRolePermission:payroll_deductions_delete');

        //Payroll-settings store
        Route::post('payroll-deduction-settings-store', 'Admin\Hr\SmPayrollController@payrollDeductionSettingsStore');

        Route::post('payroll-earning-settings-store', 'Admin\Hr\SmPayrollController@payrollEarningSettingsStore');

        Route::get('ajaxPayrollDeduction', 'Admin\Hr\SmPayrollController@ajaxPayrollDeduction');
        
        Route::get('ajaxPayrollEarnings', 'Admin\Hr\SmPayrollController@ajaxPayrollEarnings');

        //Route::get('payroll', ['as' => 'payroll', 'uses' => 'Admin\Hr\SmPayrollController@index'])->middleware('userRolePermission:payroll');
        //EPF Wages Settings
        Route::get('ajaxEpfWages', 'Admin\Hr\SmPayrollController@ajaxEpfWages');
        Route::post('payroll-epfwages-settings-store', 'Admin\Hr\SmPayrollController@epfWagesSettingsStore');

        Route::get('payroll', ['as' => 'payroll', 'uses' => 'Admin\Hr\SmPayrollController@index'])->middleware('userRolePermission:payroll');

        Route::post('trailrun', ['as' => 'trailrun', 'uses' => 'Admin\Hr\SmPayrollController@trailrun'])->middleware('userRolePermission:trailrun');

        Route::post('payroll-generate', ['as' => 'payroll_generate', 'uses' => 'Admin\Hr\SmPayrollController@generateEmployeePayroll'])->middleware('userRolePermission:payroll_generate');

        //Route::get('view-payslip/{id}', 'Admin\Hr\SmPayrollController@viewPayslip')->name('view-payslip');
        Route::get('view-payslip/{id}', ['as' => 'view_payslip', 'uses' => 'Admin\Hr\SmPayrollController@viewPayslip']);

        Route::get('download-payslip/{id}', ['as' => 'download_payslip', 'uses' => 'Admin\Hr\SmPayrollController@downloadPayslip']);
        
        Route::post('download-emp-payslip', ['as' => 'download_emp_payslip', 'uses' => 'Admin\Hr\SmPayrollController@downloadEmpPayslip']);
        
        //Route::get('download-payslip-all/{id}', ['as' => 'download_payslip_all', 'uses' => 'Admin\Hr\SmPayrollController@downloadPayslipAll']);
        
        Route::get('download-epf/{id}', ['as' => 'download_epf', 'uses' => 'Admin\Hr\SmPayrollController@downloadEpf']);

        Route::get('download-epf-all', ['as' => 'download_epf_all', 'uses' => 'Admin\Hr\SmPayrollController@downloadEpfAll']);


        Route::post('staff-earnings-store', 'Admin\Hr\SmPayrollController@staffEarningStore');
        Route::post('staff-deductions-store', 'Admin\Hr\SmPayrollController@staffDeductionStore');


        Route::get('payroll-staff-directory-ajax', ['as' => 'payroll_staff_directory_ajax', 'uses' => 'DatatableQueryController@getPayrollStaffList'])->middleware('userRolePermission:staff_directory');


        Route::post('payroll-search-staff-ajax', ['as' => 'AjaxSearchStaff', 'uses' => 'DatatableQueryController@getPayrollStaffList']);
        ...
        Route::get('payroll-calculation', ['as' => 'payroll_calculation', 'uses' => 'Admin\Hr\SmPayrollController@payrollCalculation'])->middleware('userRolePermission:payroll_calculation');

        //Payroll Calculation - staff
        //Route::get('payroll-staff/{id}', ['as' => 'viewStaff', 'uses' => 'Admin\Hr\SmStaffController@viewStaff']);

        // Route::get('payroll-calculation-staff', ['as' => 'payroll_calculation_staff', 'uses' => 'Admin\Hr\SmStaffController@payrollStaffList'])->middleware('userRolePermission:payroll_calculation_staff');
    ...
    // ->middleware('userRolePermission:examView');
    ...
    // Extra curricular student list
    Route::get('sorting-extraclass-student-list/{class_id}', ['as' => 'extraclass_sorting_student_list', 'uses' => 'SmStudentAdmissionController@extraClassSortingStudent'])->middleware('userRolePermission:unassigned_student');


    Route::get('assign-extra-curricular', 'Admin\StudentInfo\StudentExtraClassRecordController@multiRecord')->name('student.assign-extra-curricular')->middleware('userRolePermission:student.assign-extra-curricular');

    Route::get('topper-student', ['as' => 'topper_student', 'uses' => 'Admin\Examination\SmExaminationController@topperStudent']);

    Route::post('topper-student', ['as' => 'topper-student', 'uses' => 'Admin\Examination\SmExaminationController@toppersearch']);

    Route::POST('extra-curricular-record-store', 'Admin\StudentInfo\StudentExtraClassRecordController@multiRecordStore')
    ->name('extra-curricular-record-store');
    ...
    Route::get('get-extra-fees-payment-ajax', 'DatatableQueryController@ajaxExtraFeesPayment')->name('ajaxExtraFeesPayment');
    Route::get('get-extra-fees-due-ajax', 'DatatableQueryController@ajaxExtraFeesDue')->name('ajaxExtraFeesDue');
